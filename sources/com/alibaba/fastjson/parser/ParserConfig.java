...
public class ParserConfig {
    ...
    public ObjectDeserializer getDeserializer(Class<?> clazz, Type type) {
        ...
        if (deserializer2 != null) {
            ObjectDeserializer objectDeserializer = deserializer2;
        ...
        if (deserializer3 != null) {
            ObjectDeserializer objectDeserializer2 = deserializer3;
            return deserializer3;
        } else if (isPrimitive(clazz) || (annotation = (JSONType) clazz.getAnnotation(JSONType.class)) == null || (mappingTo = annotation.mappingTo()) == Void.class) {
            if ((type instanceof WildcardType) || (type instanceof TypeVariable) || (type instanceof ParameterizedType)) {
                deserializer3 = this.derializers.get(clazz);
            }
            if (deserializer3 != null) {
                ObjectDeserializer objectDeserializer3 = deserializer3;
                return deserializer3;
            }
            ObjectDeserializer deserializer4 = this.derializers.get(type);
            if (deserializer4 != null) {
                ObjectDeserializer objectDeserializer4 = deserializer4;
            ...
            ObjectDeserializer objectDeserializer5 = deserializer;
            return deserializer;
        } else {
            ObjectDeserializer objectDeserializer6 = deserializer3;
    ...
    public ObjectDeserializer registerIfNotExists(Class<?> clazz, int classModifiers, boolean fieldOnly, boolean jsonTypeSupport, boolean jsonFieldSupport, boolean fieldGenericSupport) {
        ...
        JavaBeanDeserializer javaBeanDeserializer = new JavaBeanDeserializer(this, clazz, clazz, JavaBeanInfo.build(clazz, classModifiers, clazz, fieldOnly, jsonTypeSupport, jsonFieldSupport, fieldGenericSupport));
