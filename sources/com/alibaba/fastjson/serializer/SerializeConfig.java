...
public class SerializeConfig {
    ...
    public ObjectSerializer registerIfNotExists(Class<?> clazz, int classModifers, boolean fieldOnly, boolean jsonTypeSupport, boolean jsonFieldSupport, boolean fieldGenericSupport) {
        ...
        ObjectSerializer serializer2 = new JavaBeanSerializer(clazz, classModifers, (Map<String, String>) null, fieldOnly, jsonTypeSupport, jsonFieldSupport, fieldGenericSupport);
        ...
        if (writer == null) {
            if (Map.class.isAssignableFrom(clazz)) {
                ...
                if (isCglibProxy || isJavassistProxy) {
                    ...
                    ObjectSerializer objectSerializer = writer;
                    return superWriter;
                }
                this.serializers.put(clazz, new JavaBeanSerializer(clazz));
            }
            writer = this.serializers.get(clazz);
        }
        ObjectSerializer objectSerializer2 = writer;
        return writer;
    }
