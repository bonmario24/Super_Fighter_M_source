...
public abstract class BodyRequest<T, R extends BodyRequest> extends Request<T, R> implements HasBody<R> {
    ...
    public RequestBody generateRequestBody() {
        ...
        if (this.f848bs != null && this.mediaType != null) {
            return RequestBody.create(this.mediaType, this.f848bs);
        }
    ...
    public Request.Builder generateRequestBuilder(RequestBody requestBody2) {
        try {
            headers(HttpHeaders.HEAD_KEY_CONTENT_LENGTH, String.valueOf(requestBody2.contentLength()));
        } catch (IOException e) {
