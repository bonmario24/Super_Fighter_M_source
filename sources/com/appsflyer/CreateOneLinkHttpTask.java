...
public class CreateOneLinkHttpTask extends OneLinkHttpTask {
    ...
    public CreateOneLinkHttpTask(@NonNull String str, @NonNull Map<String, String> map, AppsFlyerLibCore appsFlyerLibCore, @NonNull Context context2, boolean z) {
    ...
    public void setListener(@NonNull ResponseListener responseListener2) {
    ...
    public void initRequest(HttpsURLConnection httpsURLConnection) throws JSONException, IOException {
        if (!this.mTrackingStopped) {
            ...
            if (this.brandDomain != null) {
                jSONObject.put(BRAND_DOMAIN, this.brandDomain);
            }
