...
public class ReflectResource {
    ...
    public String[] getStringArray(String arrayIdName) {
        return proxyContext.getResources().getStringArray(getArrayId(arrayIdName));
    }

    public int getArrayId(String stringName) {
        return proxyContext.getResources().getIdentifier(stringName, "array", proxyContext.getPackageName());
    }
    ...
    public int getRawID(String rawFileName) {
        return proxyContext.getResources().getIdentifier(rawFileName, "raw", proxyContext.getPackageName());
    }
    ...
    public InputStream getRawFile(String rawFileName) {
        return proxyContext.getResources().openRawResource(getRawID(rawFileName));
    }
