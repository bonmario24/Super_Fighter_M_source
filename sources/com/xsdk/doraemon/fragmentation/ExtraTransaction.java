...
public abstract class ExtraTransaction {
    ...
    static final class ExtraTransactionImpl<T extends ISupportFragment> extends ExtraTransaction implements DontAddToBackStackTransaction {
        ...
        public void popTo(String targetFragmentTag, boolean includeTargetFragment) {
            popTo(targetFragmentTag, includeTargetFragment, (Runnable) null, Integer.MAX_VALUE);
        }
        ...
        public void popToChild(String targetFragmentTag, boolean includeTargetFragment) {
            popToChild(targetFragmentTag, includeTargetFragment, (Runnable) null, Integer.MAX_VALUE);
        }
        ...
        public void startDontHideSelf(ISupportFragment toFragment, int launchMode) {
            toFragment.getSupportDelegate().mTransactionRecord = this.mRecord;
            this.mTransactionDelegate.dispatchStartTransaction(getFragmentManager(), this.mSupportF, toFragment, 0, launchMode, 2);
        }
        ...
        public void startWithPopTo(ISupportFragment toFragment, String targetFragmentTag, boolean includeTargetFragment) {
            toFragment.getSupportDelegate().mTransactionRecord = this.mRecord;
            this.mTransactionDelegate.startWithPopTo(getFragmentManager(), this.mSupportF, toFragment, targetFragmentTag, includeTargetFragment);
        }
