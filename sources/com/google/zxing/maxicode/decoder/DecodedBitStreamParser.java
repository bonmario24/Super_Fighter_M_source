...
final class DecodedBitStreamParser {
    ...
    /* renamed from: FS */
    private static final char f49FS = '\u001c';

    /* renamed from: GS */
    private static final char f50GS = '\u001d';
    private static final char LATCHA = '￷';
    private static final char LATCHB = '￸';
    private static final char LOCK = '￹';

    /* renamed from: NS */
    private static final char f51NS = '￻';
    private static final char PAD = '￼';

    /* renamed from: RS */
    private static final char f52RS = '\u001e';
        ...
        switch (mode) {
            ...
            case 3:
                ...
                if (!result.toString().startsWith("[)>\u001e01\u001d")) {
                    result.insert(0, postcode + f50GS + country + f50GS + service + f50GS);
                    break;
                } else {
                    result.insert(9, postcode + f50GS + country + f50GS + service + f50GS);
                    break;
                }
            case 4:
