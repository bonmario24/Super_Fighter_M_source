...
public final class FirebaseAnalytics {
            ...
            synchronized (FirebaseAnalytics.class) {
                if (zza == null) {
                    if (zzz.zzb(context)) {
                        ...
                        zza = new FirebaseAnalytics(zzfw.zza(context, (zzx) null, (Long) null));
                    }
                }
            }
        }
    ...
    public final void setCurrentScreen(@NonNull Activity activity, @Size(max = 36, min = 1) @Nullable String str, @Size(max = 36, min = 1) @Nullable String str2) {
        ...
        } else if (!com.google.android.gms.measurement.internal.zzx.zza()) {
    ...
    public final void setUserId(@Nullable String str) {
        if (this.zzd) {
            ...
            this.zzb.zzh().zza("app", APEZProvider.FILEID, (Object) str, true);
        }
    }
    ...
    private FirebaseAnalytics(zzfw zzfw) {
