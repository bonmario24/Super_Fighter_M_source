...
public class AnalyticsConnectorImpl implements AnalyticsConnector {
    ...
    public AnalyticsConnector.AnalyticsConnectorHandle registerAnalyticsConnectorListener(@NonNull final String str, AnalyticsConnector.AnalyticsConnectorListener analyticsConnectorListener) {
        ...
        if ("fiam".equals(str)) {
            zzg = new zze(appMeasurement, analyticsConnectorListener);
        } else {
            zzg = ("crash".equals(str) || "clx".equals(str)) ? new zzg(appMeasurement, analyticsConnectorListener) : null;
        }
        if (zzg == null) {
            return null;
        }
        this.zza.put(str, zzg);
