...
public final class zzeg extends GmsClient<zzer> implements zzeh {
    ...
    public final String getStartServicePackage() {
        if (this.zzc.zza) {
            zza.mo21227i("Preparing to create service connection to fallback implementation", new Object[0]);
            return this.zzb.getPackageName();
        }
        zza.mo21227i("Preparing to create service connection to gms implementation", new Object[0]);
    ...
    public final Bundle getGetServiceRequestExtraArgs() {
        ...
        if (this.zzc != null) {
            getServiceRequestExtraArgs.putString("com.google.firebase.auth.API_KEY", this.zzc.zzb());
        }
