...
public final class zzey {
    ...
    public final String zza() {
        ...
        return String.format("X%s", new Object[]{Integer.toString(this.zzb)});
    }
    ...
    private static int zzd(String str) {
        try {
            ...
            if (zza2.size() >= 3) {
                return Integer.parseInt(zza2.get(2)) + (1000000 * Integer.parseInt(zza2.get(0))) + (Integer.parseInt(zza2.get(1)) * 1000);
            }
            return -1;
