...
public final class zzas extends zzak<zzew> {
    ...
    public final Task<AuthResult> zza(FirebaseApp firebaseApp, String str, @Nullable String str2, zzb zzb2) {
        zzcw zzcw = (zzcw) new zzcw(str, str2).zza(firebaseApp).zza(zzb2);
        return zza(zzb(zzcw), zzcw);
    }

    public final Task<AuthResult> zza(FirebaseApp firebaseApp, AuthCredential authCredential, @Nullable String str, zzb zzb2) {
        zzcu zzcu = (zzcu) new zzcu(authCredential, str).zza(firebaseApp).zza(zzb2);
        return zza(zzb(zzcu), zzcu);
    }

    public final Task<Void> zza(FirebaseApp firebaseApp, FirebaseUser firebaseUser, AuthCredential authCredential, @Nullable String str, zzbc zzbc) {
    ...
    public final Task<AuthResult> zzb(FirebaseApp firebaseApp, FirebaseUser firebaseUser, AuthCredential authCredential, @Nullable String str, zzbc zzbc) {
    ...
    public final Task<AuthResult> zza(FirebaseApp firebaseApp, zzb zzb2, @Nullable String str) {
        zzcs zzcs = (zzcs) new zzcs(str).zza(firebaseApp).zza(zzb2);
        return zza(zzb(zzcs), zzcs);
    }

    public final void zza(FirebaseApp firebaseApp, zzfr zzfr, PhoneAuthProvider.OnVerificationStateChangedCallbacks onVerificationStateChangedCallbacks, @Nullable Activity activity, Executor executor) {
    ...
    public final Task<AuthResult> zzb(FirebaseApp firebaseApp, String str, String str2, @Nullable String str3, zzb zzb2) {
    ...
    public final Task<Void> zza(FirebaseApp firebaseApp, FirebaseUser firebaseUser, String str, String str2, @Nullable String str3, zzbc zzbc) {
    ...
    public final Task<AuthResult> zza(FirebaseApp firebaseApp, PhoneAuthCredential phoneAuthCredential, @Nullable String str, zzb zzb2) {
        zzdc zzdc = (zzdc) new zzdc(phoneAuthCredential, str).zza(firebaseApp).zza(zzb2);
        return zza(zzb(zzdc), zzdc);
    }

    public final Task<Void> zza(FirebaseApp firebaseApp, FirebaseUser firebaseUser, PhoneAuthCredential phoneAuthCredential, @Nullable String str, zzbc zzbc) {
    ...
    public final Task<AuthResult> zzb(FirebaseApp firebaseApp, FirebaseUser firebaseUser, PhoneAuthCredential phoneAuthCredential, @Nullable String str, zzbc zzbc) {
    ...
    public final Task<AuthResult> zza(FirebaseApp firebaseApp, FirebaseUser firebaseUser, AuthCredential authCredential, zzbc zzbc) {
        ...
        if (authCredential instanceof EmailAuthCredential) {
            if (!((EmailAuthCredential) authCredential).zzg()) {
                zzbm zzbm = (zzbm) new zzbm((EmailAuthCredential) authCredential).zza(firebaseApp).zza(firebaseUser).zza(zzbc).zza((zzae) zzbc);
                return zza(zzb(zzbm), zzbm);
            }
            zzbs zzbs = (zzbs) new zzbs((EmailAuthCredential) authCredential).zza(firebaseApp).zza(firebaseUser).zza(zzbc).zza((zzae) zzbc);
    ...
    public final Task<Void> zza(zzw zzw, String str, @Nullable String str2, long j, boolean z, boolean z2, PhoneAuthProvider.OnVerificationStateChangedCallbacks onVerificationStateChangedCallbacks, Executor executor, @Nullable Activity activity) {
        zzde zzde = new zzde(zzw, str, str2, j, z, z2);
        zzde.zza(onVerificationStateChangedCallbacks, activity, executor);
        return zzb(zzde);
    }

    public final Task<Void> zza(FirebaseApp firebaseApp, PhoneMultiFactorAssertion phoneMultiFactorAssertion, FirebaseUser firebaseUser, @Nullable String str, zzb zzb2) {
        zzbg zzbg = new zzbg(phoneMultiFactorAssertion, firebaseUser.zzf(), str);
        zzbg.zza(firebaseApp).zza(zzb2);
        return zzb(zzbg);
    }

    public final Task<Void> zza(zzw zzw, PhoneMultiFactorInfo phoneMultiFactorInfo, @Nullable String str, long j, boolean z, boolean z2, PhoneAuthProvider.OnVerificationStateChangedCallbacks onVerificationStateChangedCallbacks, Executor executor, @Nullable Activity activity) {
        zzdg zzdg = new zzdg(phoneMultiFactorInfo, zzw.zzb(), str, j, z, z2);
        zzdg.zza(onVerificationStateChangedCallbacks, activity, executor);
        return zzb(zzdg);
    }

    public final Task<AuthResult> zza(FirebaseApp firebaseApp, @Nullable FirebaseUser firebaseUser, PhoneMultiFactorAssertion phoneMultiFactorAssertion, String str, zzb zzb2) {
