...
public abstract class zzak<T extends zzam> {
    ...
    private final GoogleApi<T> zza(String str) {
        ...
        if (zzc.zzc.zza(str)) {
            ...
            logger.mo21227i(new StringBuilder(String.valueOf(valueOf).length() + 43).append("getGoogleApiForMethod() returned Fallback: ").append(valueOf).toString(), new Object[0]);
            return zzc.zzb;
        }
        Logger logger2 = zza;
        String valueOf2 = String.valueOf(zzc.zza);
        logger2.mo21227i(new StringBuilder(String.valueOf(valueOf2).length() + 38).append("getGoogleApiForMethod() returned Gms: ").append(valueOf2).toString(), new Object[0]);
        return zzc.zza;
    }
