    ...
    public final void onReceive(Context context, Intent intent) {
        ...
        if (intent.hasExtra("com.google.firebase.auth.internal.OPERATION")) {
            ...
            if ("com.google.firebase.auth.internal.SIGN_IN".equals(stringExtra)) {
                ...
                this.zzb.setException(zzej.zza(zzy.zza(new StringBuilder(String.valueOf(stringExtra).length() + 50).append("WEB_CONTEXT_CANCELED:Unknown operation received (").append(stringExtra).append(")").toString())));
            }
