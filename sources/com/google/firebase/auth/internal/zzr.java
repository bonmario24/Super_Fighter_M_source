...
public final class zzr implements FirebaseUserMetadata {
    ...
    @SafeParcelable.Field(getter = "getLastSignInTimestamp", mo21170id = 1)
    private long zza;
    @SafeParcelable.Field(getter = "getCreationTimestamp", mo21170id = 2)
    private long zzb;

    @SafeParcelable.Constructor
    public zzr(@SafeParcelable.Param(mo21173id = 1) long j, @SafeParcelable.Param(mo21173id = 2) long j2) {
        this.zza = j;
        this.zzb = j2;
    }
