...
public class DataCollectionConfigStorage {
    ...
    public DataCollectionConfigStorage(Context applicationContext2, String persistenceKey, Publisher publisher2) {
        ...
        this.sharedPreferences = applicationContext2.getSharedPreferences(FIREBASE_APP_PREFS + persistenceKey, 0);
        this.publisher = publisher2;
    }

    private static Context directBootSafe(Context applicationContext2) {
        return (Build.VERSION.SDK_INT < 24 || ContextCompat.isDeviceProtectedStorage(applicationContext2)) ? applicationContext2 : ContextCompat.createDeviceProtectedStorageContext(applicationContext2);
    }
