...
public final class HintRequest extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    @SafeParcelable.Field(getter = "getAccountTypes", mo21170id = 4)
    ...
    @SafeParcelable.Field(getter = "getHintPickerConfig", mo21170id = 1)
    private final CredentialPickerConfig zzah;
    @SafeParcelable.Field(getter = "isEmailAddressIdentifierSupported", mo21170id = 2)
    private final boolean zzai;
    @SafeParcelable.Field(getter = "isPhoneNumberIdentifierSupported", mo21170id = 3)
    private final boolean zzaj;
    @SafeParcelable.Field(mo21170id = 1000)
    private final int zzu;

    @SafeParcelable.Constructor
    HintRequest(@SafeParcelable.Param(mo21173id = 1000) int i, @SafeParcelable.Param(mo21173id = 1) CredentialPickerConfig credentialPickerConfig, @SafeParcelable.Param(mo21173id = 2) boolean z, @SafeParcelable.Param(mo21173id = 3) boolean z2, @SafeParcelable.Param(mo21173id = 4) String[] strArr, @SafeParcelable.Param(mo21173id = 5) boolean z3, @SafeParcelable.Param(mo21173id = 6) String str, @SafeParcelable.Param(mo21173id = 7) String str2) {
        this.zzu = i;
