...
public final class IdToken extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    @SafeParcelable.Field(getter = "getAccountType", mo21170id = 1)
    @NonNull
    private final String zzr;

    @SafeParcelable.Constructor
    public IdToken(@SafeParcelable.Param(mo21173id = 1) @NonNull String str, @SafeParcelable.Param(mo21173id = 2) @NonNull String str2) {
        boolean z = true;
