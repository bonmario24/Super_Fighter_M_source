...
public final class CredentialRequest extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getAccountTypes", mo21170id = 2)
    private final String[] zzaa;
    @SafeParcelable.Field(getter = "getCredentialPickerConfig", mo21170id = 3)
    private final CredentialPickerConfig zzab;
    @SafeParcelable.Field(getter = "getCredentialHintPickerConfig", mo21170id = 4)
    private final CredentialPickerConfig zzac;
    @SafeParcelable.Field(getter = "isIdTokenRequested", mo21170id = 5)
    private final boolean zzad;
    @SafeParcelable.Field(getter = "getServerClientId", mo21170id = 6)
    private final String zzae;
    @SafeParcelable.Field(getter = "getIdTokenNonce", mo21170id = 7)
    private final String zzaf;
    @SafeParcelable.Field(getter = "getRequireUserMediation", mo21170id = 8)
    private final boolean zzag;
    @SafeParcelable.Field(mo21170id = 1000)
    private final int zzu;
    @SafeParcelable.Field(getter = "isPasswordLoginSupported", mo21170id = 1)
    private final boolean zzz;

    @SafeParcelable.Constructor
    CredentialRequest(@SafeParcelable.Param(mo21173id = 1000) int i, @SafeParcelable.Param(mo21173id = 1) boolean z, @SafeParcelable.Param(mo21173id = 2) String[] strArr, @SafeParcelable.Param(mo21173id = 3) CredentialPickerConfig credentialPickerConfig, @SafeParcelable.Param(mo21173id = 4) CredentialPickerConfig credentialPickerConfig2, @SafeParcelable.Param(mo21173id = 5) boolean z2, @SafeParcelable.Param(mo21173id = 6) String str, @SafeParcelable.Param(mo21173id = 7) String str2, @SafeParcelable.Param(mo21173id = 8) boolean z3) {
        this.zzu = i;
        this.zzz = z;
