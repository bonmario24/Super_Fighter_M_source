...
public class ProxyRequest extends AbstractSafeParcelable {
    ...
    ProxyRequest(@SafeParcelable.Param(mo21173id = 1000) int i, @SafeParcelable.Param(mo21173id = 1) String str, @SafeParcelable.Param(mo21173id = 2) int i2, @SafeParcelable.Param(mo21173id = 3) long j, @SafeParcelable.Param(mo21173id = 4) byte[] bArr, @SafeParcelable.Param(mo21173id = 5) Bundle bundle) {
        this.versionCode = i;
        this.url = str;
        this.httpMethod = i2;
