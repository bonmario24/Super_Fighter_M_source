...
public class ProxyResponse extends AbstractSafeParcelable {
    ...
    ProxyResponse(@SafeParcelable.Param(mo21173id = 1000) int i, @SafeParcelable.Param(mo21173id = 1) int i2, @SafeParcelable.Param(mo21173id = 2) PendingIntent pendingIntent, @SafeParcelable.Param(mo21173id = 3) int i3, @SafeParcelable.Param(mo21173id = 4) Bundle bundle, @SafeParcelable.Param(mo21173id = 5) byte[] bArr) {
        this.versionCode = i;
