...
public class SignInAccount extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    @SafeParcelable.Field(defaultValue = "", mo21170id = 4)
    @Deprecated
    private String zzba;
    @SafeParcelable.Field(getter = "getGoogleSignInAccount", mo21170id = 7)
    private GoogleSignInAccount zzbb;
    @SafeParcelable.Field(defaultValue = "", mo21170id = 8)
    @Deprecated
    private String zzbc;

    @SafeParcelable.Constructor
    SignInAccount(@SafeParcelable.Param(mo21173id = 4) String str, @SafeParcelable.Param(mo21173id = 7) GoogleSignInAccount googleSignInAccount, @SafeParcelable.Param(mo21173id = 8) String str2) {
