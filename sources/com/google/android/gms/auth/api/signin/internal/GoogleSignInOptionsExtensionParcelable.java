...
public class GoogleSignInOptionsExtensionParcelable extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getBundle", mo21170id = 3)
    private Bundle mBundle;
    @SafeParcelable.Field(getter = "getType", mo21170id = 2)
    private int mType;
    @SafeParcelable.VersionField(mo21176id = 1)
    private final int versionCode;

    @SafeParcelable.Constructor
    GoogleSignInOptionsExtensionParcelable(@SafeParcelable.Param(mo21173id = 1) int i, @SafeParcelable.Param(mo21173id = 2) int i2, @SafeParcelable.Param(mo21173id = 3) Bundle bundle) {
        this.versionCode = i;
        this.mType = i2;
        this.mBundle = bundle;
    }
