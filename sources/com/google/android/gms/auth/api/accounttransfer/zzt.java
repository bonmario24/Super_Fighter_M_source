...
public class zzt extends zzaz {
    ...
    @SafeParcelable.Field(getter = "getAccountType", mo21170id = 2)
    private String zzbn;
    @SafeParcelable.Field(getter = "getStatus", mo21170id = 3)
    private int zzbo;
    @SafeParcelable.Field(getter = "getTransferBytes", mo21170id = 4)
    private byte[] zzbp;
    @SafeParcelable.Field(getter = "getPendingIntent", mo21170id = 5)
    private PendingIntent zzbq;
    @SafeParcelable.Field(getter = "getDeviceMetaData", mo21170id = 6)
    private DeviceMetaData zzbr;
    @SafeParcelable.VersionField(mo21176id = 1)
    private final int zzv;

    @SafeParcelable.Constructor
    zzt(@SafeParcelable.Indicator Set<Integer> set, @SafeParcelable.Param(mo21173id = 1) int i, @SafeParcelable.Param(mo21173id = 2) String str, @SafeParcelable.Param(mo21173id = 3) int i2, @SafeParcelable.Param(mo21173id = 4) byte[] bArr, @SafeParcelable.Param(mo21173id = 5) PendingIntent pendingIntent, @SafeParcelable.Param(mo21173id = 6) DeviceMetaData deviceMetaData) {
        this.zzba = set;
        this.zzv = i;
        this.zzbn = str;
        this.zzbo = i2;
