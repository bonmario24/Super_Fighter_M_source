...
public class AccountChangeEventsRequest extends AbstractSafeParcelable {
    ...
    AccountChangeEventsRequest(@SafeParcelable.Param(mo21173id = 1) int i, @SafeParcelable.Param(mo21173id = 2) int i2, @SafeParcelable.Param(mo21173id = 3) String str, @SafeParcelable.Param(mo21173id = 4) Account account) {
        this.zze = i;
        this.zzi = i2;
        this.zzg = str;
