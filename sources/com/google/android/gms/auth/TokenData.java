...
public class TokenData extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    @SafeParcelable.Field(getter = "getGrantedScopes", mo21170id = 6)
    private final List<String> zzaa;
    @SafeParcelable.Field(getter = "getScopeData", mo21170id = 7)
    private final String zzab;
    @SafeParcelable.VersionField(mo21176id = 1)
    private final int zzv;
    @SafeParcelable.Field(getter = "getToken", mo21170id = 2)
    private final String zzw;
    @SafeParcelable.Field(getter = "getExpirationTimeSecs", mo21170id = 3)
    private final Long zzx;
    @SafeParcelable.Field(getter = "isCached", mo21170id = 4)
    private final boolean zzy;
    @SafeParcelable.Field(getter = "isSnowballed", mo21170id = 5)
    ...
    TokenData(@SafeParcelable.Param(mo21173id = 1) int i, @SafeParcelable.Param(mo21173id = 2) String str, @SafeParcelable.Param(mo21173id = 3) Long l, @SafeParcelable.Param(mo21173id = 4) boolean z, @SafeParcelable.Param(mo21173id = 5) boolean z2, @SafeParcelable.Param(mo21173id = 6) List<String> list, @SafeParcelable.Param(mo21173id = 7) String str2) {
        this.zzv = i;
