...
public class ResolveAccountResponse extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getConnectionResult", mo21170id = 3)
    private ConnectionResult zapo;
    @SafeParcelable.Field(getter = "getSaveDefaultAccount", mo21170id = 4)
    private boolean zapp;
    @SafeParcelable.Field(getter = "isFromCrossClientAuth", mo21170id = 5)
    private boolean zapq;

    @SafeParcelable.Constructor
    ResolveAccountResponse(@SafeParcelable.Param(mo21173id = 1) int i, @SafeParcelable.Param(mo21173id = 2) IBinder iBinder, @SafeParcelable.Param(mo21173id = 3) ConnectionResult connectionResult, @SafeParcelable.Param(mo21173id = 4) boolean z, @SafeParcelable.Param(mo21173id = 5) boolean z2) {
        this.versionCode = i;
        this.zapn = iBinder;
