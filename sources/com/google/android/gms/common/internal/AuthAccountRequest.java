...
public class AuthAccountRequest extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(mo21170id = 6, type = "android.accounts.Account")
    private Account zax;

    @SafeParcelable.Constructor
    AuthAccountRequest(@SafeParcelable.Param(mo21173id = 1) int i, @SafeParcelable.Param(mo21173id = 2) IBinder iBinder, @SafeParcelable.Param(mo21173id = 3) Scope[] scopeArr, @SafeParcelable.Param(mo21173id = 4) Integer num, @SafeParcelable.Param(mo21173id = 5) Integer num2, @SafeParcelable.Param(mo21173id = 6) Account account) {
        this.zali = i;
        this.zaob = iBinder;
        this.zaoc = scopeArr;
        this.zaod = num;
    ...
    public Account getAccount() {
        ...
        if (this.zaob != null) {
            return AccountAccessor.getAccountBinderSafe(IAccountAccessor.Stub.asInterface(this.zaob));
        }
        return null;
    }
