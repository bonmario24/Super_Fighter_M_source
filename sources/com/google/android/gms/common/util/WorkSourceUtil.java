...
public class WorkSourceUtil {
    ...
    private static void zza(WorkSource workSource, int i, @Nullable String str) {
        if (zzib != null) {
            ...
            try {
                zzia.invoke(workSource, new Object[]{Integer.valueOf(i)});
            } catch (Exception e2) {
    ...
    public static WorkSource fromPackageAndModuleExperimentalPi(Context context, String str, String str2) {
        ...
        if (context == null || context.getPackageManager() == null || str2 == null || str == null) {
            ...
            if (zzd >= 0) {
                ...
                if (zzif == null || zzig == null) {
                    zza(workSource, zzd, str);
                } else {
                    try {
                        Object invoke = zzif.invoke(workSource, new Object[0]);
                        if (zzd != zzhz) {
    ...
    private static int zza(WorkSource workSource) {
        if (zzic != null) {
            try {
                return ((Integer) zzic.invoke(workSource, new Object[0])).intValue();
            } catch (Exception e) {
                Log.wtf("WorkSourceUtil", "Unable to assign blame through WorkSource", e);
            }
        }
    ...
    private static String zza(WorkSource workSource, int i) {
        if (zzie != null) {
            try {
                return (String) zzie.invoke(workSource, new Object[]{Integer.valueOf(i)});
            } catch (Exception e) {
                Log.wtf("WorkSourceUtil", "Unable to assign blame through WorkSource", e);
            }
        }
