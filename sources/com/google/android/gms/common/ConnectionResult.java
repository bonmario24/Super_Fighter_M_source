...
public final class ConnectionResult extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getErrorCode", mo21170id = 2)
    private final int zzr;
    @SafeParcelable.Field(getter = "getResolution", mo21170id = 3)
    private final PendingIntent zzs;
    @SafeParcelable.Field(getter = "getErrorMessage", mo21170id = 4)
    private final String zzt;

    @SafeParcelable.Constructor
    ConnectionResult(@SafeParcelable.Param(mo21173id = 1) int i, @SafeParcelable.Param(mo21173id = 2) int i2, @SafeParcelable.Param(mo21173id = 3) PendingIntent pendingIntent, @SafeParcelable.Param(mo21173id = 4) String str) {
        this.zzq = i;
        this.zzr = i2;
