...
public abstract class FastJsonResponse {
    ...
    public static class Field<I, O> extends AbstractSafeParcelable {
        ...
        @SafeParcelable.VersionField(getter = "getVersionCode", mo21176id = 1)
        private final int zali;
        @SafeParcelable.Field(getter = "getTypeIn", mo21170id = 2)
        protected final int zaqf;
        @SafeParcelable.Field(getter = "isTypeInArray", mo21170id = 3)
        protected final boolean zaqg;
        @SafeParcelable.Field(getter = "getTypeOut", mo21170id = 4)
        protected final int zaqh;
        @SafeParcelable.Field(getter = "isTypeOutArray", mo21170id = 5)
        protected final boolean zaqi;
        @SafeParcelable.Field(getter = "getOutputFieldName", mo21170id = 6)
        protected final String zaqj;
        @SafeParcelable.Field(getter = "getSafeParcelableFieldId", mo21170id = 7)
        protected final int zaqk;
        protected final Class<? extends FastJsonResponse> zaql;
        @SafeParcelable.Field(getter = "getConcreteTypeName", mo21170id = 8)
        private final String zaqm;
        private zaj zaqn;
        /* access modifiers changed from: private */
        @SafeParcelable.Field(getter = "getWrappedConverter", mo21170id = 9, type = "com.google.android.gms.common.server.converter.ConverterWrapper")
        public FieldConverter<I, O> zaqo;

        @SafeParcelable.Constructor
        Field(@SafeParcelable.Param(mo21173id = 1) int i, @SafeParcelable.Param(mo21173id = 2) int i2, @SafeParcelable.Param(mo21173id = 3) boolean z, @SafeParcelable.Param(mo21173id = 4) int i3, @SafeParcelable.Param(mo21173id = 5) boolean z2, @SafeParcelable.Param(mo21173id = 6) String str, @SafeParcelable.Param(mo21173id = 7) int i4, @SafeParcelable.Param(mo21173id = 8) String str2, @SafeParcelable.Param(mo21173id = 9) zab zab) {
            this.zali = i;
            this.zaqf = i2;
            this.zaqg = z;
            this.zaqh = i3;
        ...
        private final zab zacm() {
            ...
            return zab.zaa(this.zaqo);
        }

        public final FastJsonResponse zacn() throws InstantiationException, IllegalAccessException {
            if (this.zaql != SafeParcelResponse.class) {
                return (FastJsonResponse) this.zaql.newInstance();
            }
        ...
        public String toString() {
            ...
            if (this.zaqo != null) {
                add.add("converterName", this.zaqo.getClass().getCanonicalName());
            }
            return add.toString();
        }
    }
