...
public final class zaj extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getSerializedDictionary", mo21170id = 2)
    private final ArrayList<zam> zark;
    @SafeParcelable.Field(getter = "getRootClassName", mo21170id = 3)
    private final String zarl;

    @SafeParcelable.Constructor
    zaj(@SafeParcelable.Param(mo21173id = 1) int i, @SafeParcelable.Param(mo21173id = 2) ArrayList<zam> arrayList, @SafeParcelable.Param(mo21173id = 3) String str) {
        this.zali = i;
        this.zark = null;
