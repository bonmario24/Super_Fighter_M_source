...
public final class StringToIntConverter extends AbstractSafeParcelable implements FastJsonResponse.FieldConverter<String, Integer> {
    ...
    @SafeParcelable.Field(getter = "getSerializedMap", mo21170id = 2)
    private final ArrayList<zaa> zaqe;

    @SafeParcelable.Constructor
    StringToIntConverter(@SafeParcelable.Param(mo21173id = 1) int i, @SafeParcelable.Param(mo21173id = 2) ArrayList<zaa> arrayList) {
        this.zali = i;
    ...
    public static final class zaa extends AbstractSafeParcelable {
        ...
        @SafeParcelable.Constructor
        zaa(@SafeParcelable.Param(mo21173id = 1) int i, @SafeParcelable.Param(mo21173id = 2) String str, @SafeParcelable.Param(mo21173id = 3) int i2) {
            this.versionCode = i;
            this.zaqa = str;
            this.zaqb = i2;
        }
