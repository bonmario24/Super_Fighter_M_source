...
public final class zacp {
    ...
    /* JADX WARNING: type inference failed for: r7v0, types: [com.google.android.gms.common.api.ResultCallback, com.google.android.gms.common.api.zac, com.google.android.gms.common.api.internal.zacq, com.google.android.gms.common.api.internal.zaco] */
    public final void release() {
        ? r7 = 0;
        for (BasePendingResult basePendingResult : (BasePendingResult[]) this.zald.toArray(zalc)) {
            basePendingResult.zaa((zacq) r7);
            if (basePendingResult.zal() != null) {
                ...
                if (basePendingResult.isReady()) {
                    basePendingResult.zaa((zacq) new zacr(basePendingResult, r7, serviceBrokerBinder, r7));
                } else if (serviceBrokerBinder == null || !serviceBrokerBinder.isBinderAlive()) {
                    basePendingResult.zaa((zacq) r7);
                    basePendingResult.cancel();
                    r7.remove(basePendingResult.zal().intValue());
                } else {
