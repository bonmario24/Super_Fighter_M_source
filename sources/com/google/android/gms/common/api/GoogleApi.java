...
public class GoogleApi<O extends Api.ApiOptions> implements HasApiKey<O> {
    ...
    public ClientSettings.Builder createClientSettingsBuilder() {
        ...
        if ((this.zabj instanceof Api.ApiOptions.HasGoogleSignInAccountOptions) && (googleSignInAccount2 = ((Api.ApiOptions.HasGoogleSignInAccountOptions) this.zabj).getGoogleSignInAccount()) != null) {
            account = googleSignInAccount2.getAccount();
        } else if (this.zabj instanceof Api.ApiOptions.HasAccountOptions) {
            account = ((Api.ApiOptions.HasAccountOptions) this.zabj).getAccount();
        } else {
            account = null;
        }
        ClientSettings.Builder account2 = builder.setAccount(account);
        if (!(this.zabj instanceof Api.ApiOptions.HasGoogleSignInAccountOptions) || (googleSignInAccount = ((Api.ApiOptions.HasGoogleSignInAccountOptions) this.zabj).getGoogleSignInAccount()) == null) {
