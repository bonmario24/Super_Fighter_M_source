...
public class Configuration extends AbstractSafeParcelable implements Comparable<Configuration> {
    ...
    public Configuration(@SafeParcelable.Param(mo21173id = 2) int i, @SafeParcelable.Param(mo21173id = 3) zzi[] zziArr, @SafeParcelable.Param(mo21173id = 4) String[] strArr) {
        this.zzc = i;
        this.zzd = zziArr;
        for (zzi zzi : zziArr) {
