...
public final class zzfn {
    ...
    public final void zza(String str) {
        ...
        if (resolveInfo.serviceInfo != null) {
            ...
            try {
                this.zza.zzr().zzx().zza("Install Referrer Service is", ConnectionTracker.getInstance().bindService(this.zza.zzn(), new Intent(intent), zzfm, 1) ? "available" : "not available");
            } catch (Exception e) {
