...
public final class zzez extends zzkb {
    private final SSLSocketFactory zzb;

    public zzez(zzka zzka) {
        super(zzka);
        this.zzb = Build.VERSION.SDK_INT < 19 ? new zzkl() : null;
    }
    ...
    public final HttpURLConnection zza(URL url) throws IOException {
        ...
        if (this.zzb != null && (openConnection instanceof HttpsURLConnection)) {
            ((HttpsURLConnection) openConnection).setSSLSocketFactory(this.zzb);
        }
