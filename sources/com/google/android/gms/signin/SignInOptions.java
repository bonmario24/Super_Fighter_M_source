...
public final class SignInOptions implements Api.ApiOptions.Optional {
    ...
    public final Bundle toBundle() {
        ...
        if (this.zast != null) {
            bundle.putLong("com.google.android.gms.signin.internal.authApiSignInModuleVersion", this.zast.longValue());
        }
        if (this.zasu != null) {
            bundle.putLong("com.google.android.gms.signin.internal.realClientLibraryVersion", this.zasu.longValue());
        }
        return bundle;
    }
