...
final class zzjs {
    ...
    private static void zza(zzjr zzjr, StringBuilder sb, int i) {
        ...
        for (String str2 : treeSet) {
            ...
            if (substring.endsWith("Map") && !substring.equals("Map")) {
                ...
                if (method3 != null && method3.getReturnType().equals(Map.class) && !method3.isAnnotationPresent(Deprecated.class) && Modifier.isPublic(method3.getModifiers())) {
                    zza(sb, i, zza(str), zzig.zza(method3, (Object) zzjr, new Object[0]));
                }
            }
            ...
            if (((Method) hashMap2.get(valueOf5.length() != 0 ? "set".concat(valueOf5) : new String("set"))) != null) {
                ...
                if (method4 != null) {
                    ...
                    if (method5 == null) {
                        ...
                        booleanValue = ((Boolean) zzig.zza(method5, (Object) zzjr, new Object[0])).booleanValue();
                    }
                    if (booleanValue) {
        ...
        if (((zzig) zzjr).zzb != null) {
            ((zzig) zzjr).zzb.zza(sb, i);
        }
    }
    ...
    static final void zza(StringBuilder sb, int i, String str, Object obj) {
        ...
        if (obj instanceof List) {
            ...
            if (obj instanceof String) {
                sb.append(": \"").append(zzkv.zza(zzgv.zza((String) obj))).append('\"');
            } else if (obj instanceof zzgv) {
                sb.append(": \"").append(zzkv.zza((zzgv) obj)).append('\"');
