...
public final class zzp {
    ...
    public static final class zzk extends zzig<zzk, zza> implements zzjt {
        ...
        public final zzr zze() {
            return this.zzh == null ? zzr.zzf() : this.zzh;
        }
    ...
    public static final class zzl extends zzig<zzl, zzb> implements zzjt {
        ...
        /* compiled from: com.google.firebase:firebase-auth@@19.3.2 */
        public static final class zza extends zzig<zza, C1795zza> implements zzjt {
            /* access modifiers changed from: private */
            ...
            /* compiled from: com.google.firebase:firebase-auth@@19.3.2 */
            public static final class C1795zza extends zzig.zzb<zza, C1795zza> implements zzjt {
                private C1795zza() {
                    super(zza.zze);
                }

                public final C1795zza zza(String str) {
                    if (this.zzb) {
                        zzb();
                        this.zzb = false;
                    }
            ...
            public static C1795zza zza() {
                return (C1795zza) zze.zzz();
            }
    ...
    /* compiled from: com.google.firebase:firebase-auth@@19.3.2 */
    public static final class zza extends zzig<zza, C1794zza> implements zzjt {
        /* access modifiers changed from: private */
        ...
        /* compiled from: com.google.firebase:firebase-auth@@19.3.2 */
        public static final class C1794zza extends zzig.zzb<zza, C1794zza> implements zzjt {
            private C1794zza() {
                super(zza.zzs);
            }

            public final C1794zza zza(String str) {
                if (this.zzb) {
                    zzb();
                    this.zzb = false;
                }
            ...
            public final C1794zza zzb(String str) {
                if (this.zzb) {
                    zzb();
                    this.zzb = false;
                }
            ...
            public final C1794zza zzc(String str) {
                if (this.zzb) {
                    zzb();
                    this.zzb = false;
                }
        ...
        public static C1794zza zza() {
            return (C1794zza) zzs.zzz();
        }
    ...
    public static final class zzn extends zzig<zzn, zzb> implements zzjt {
        ...
        /* compiled from: com.google.firebase:firebase-auth@@19.3.2 */
        public static final class zza extends zzig<zza, C1796zza> implements zzjt {
            /* access modifiers changed from: private */
            ...
            /* compiled from: com.google.firebase:firebase-auth@@19.3.2 */
            public static final class C1796zza extends zzig.zzb<zza, C1796zza> implements zzjt {
                private C1796zza() {
                    super(zza.zzd);
                }

                /* synthetic */ C1796zza(zzo zzo) {
                    this();
                }
            }
    ...
    /* compiled from: com.google.firebase:firebase-auth@@19.3.2 */
    public static final class C1797zzp extends zzig<C1797zzp, zza> implements zzjt {
        /* access modifiers changed from: private */
        public static final C1797zzp zzo;
        private static volatile zzkb<C1797zzp> zzp;
        private int zzc;
        private String zzd = "";
        private String zze = "";
        private String zzf = "";
        ...
        /* compiled from: com.google.firebase:firebase-auth@@19.3.2 */
        public static final class zza extends zzig.zzb<C1797zzp, zza> implements zzjt {
            private zza() {
                super(C1797zzp.zzo);
            }
        ...
        public final Object zza(int i, Object obj, Object obj2) {
            ...
            switch (zzo.zza[i - 1]) {
                ...
                case 4:
                    return zzo;
                case 5:
                    zzkb<C1797zzp> zzkb2 = zzp;
                    if (zzkb2 != null) {
                        return zzkb2;
                    }
                    synchronized (C1797zzp.class) {
                        zzkb = zzp;
                        if (zzkb == null) {
        ...
        static {
            C1797zzp zzp2 = new C1797zzp();
            zzo = zzp2;
            zzig.zza(C1797zzp.class, zzp2);
        }
    }
