...
public final class zzeg extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getUserProfileChangeRequest", mo21170id = 1)
    private final UserProfileChangeRequest zza;
    @SafeParcelable.Field(getter = "getCachedState", mo21170id = 2)
    private final String zzb;

    @SafeParcelable.Constructor
    public zzeg(@SafeParcelable.Param(mo21173id = 1) UserProfileChangeRequest userProfileChangeRequest, @SafeParcelable.Param(mo21173id = 2) String str) {
