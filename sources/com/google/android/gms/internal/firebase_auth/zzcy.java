...
public final class zzcy extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getCredential", mo21170id = 2)
    private final PhoneAuthCredential zzb;

    @SafeParcelable.Constructor
    public zzcy(@SafeParcelable.Param(mo21173id = 1) String str, @SafeParcelable.Param(mo21173id = 2) PhoneAuthCredential phoneAuthCredential) {
        this.zza = str;
