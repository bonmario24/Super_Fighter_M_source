...
interface zziq {
    ...
    void zza(int i, zzdw zzdw) throws IOException;

    <K, V> void zza(int i, zzgh<K, V> zzgh, Map<K, V> map) throws IOException;

    void zza(int i, Object obj) throws IOException;

    void zza(int i, Object obj, zzhf zzhf) throws IOException;

    void zza(int i, String str) throws IOException;

    void zza(int i, List<String> list) throws IOException;

    void zza(int i, List<?> list, zzhf zzhf) throws IOException;
    ...
    @Deprecated
    void zzb(int i, Object obj, zzhf zzhf) throws IOException;

    void zzb(int i, List<zzdw> list) throws IOException;

    @Deprecated
    void zzb(int i, List<?> list, zzhf zzhf) throws IOException;
