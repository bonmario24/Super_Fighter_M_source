...
interface zzhc {
    ...
    <T> T zza(zzhf<T> zzhf, zzer zzer) throws IOException;

    void zza(List<Double> list) throws IOException;

    <T> void zza(List<T> list, zzhf<T> zzhf, zzer zzer) throws IOException;

    <K, V> void zza(Map<K, V> map, zzgh<K, V> zzgh, zzer zzer) throws IOException;

    int zzb();

    @Deprecated
    <T> T zzb(zzhf<T> zzhf, zzer zzer) throws IOException;

    void zzb(List<Float> list) throws IOException;

    @Deprecated
    <T> void zzb(List<T> list, zzhf<T> zzhf, zzer zzer) throws IOException;
