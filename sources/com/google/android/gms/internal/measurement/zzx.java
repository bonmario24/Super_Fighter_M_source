...
public final class zzx extends AbstractSafeParcelable {
    ...
    public zzx(@SafeParcelable.Param(mo21173id = 1) long j, @SafeParcelable.Param(mo21173id = 2) long j2, @SafeParcelable.Param(mo21173id = 3) boolean z, @SafeParcelable.Param(mo21173id = 4) String str, @SafeParcelable.Param(mo21173id = 5) String str2, @SafeParcelable.Param(mo21173id = 6) String str3, @SafeParcelable.Param(mo21173id = 7) Bundle bundle) {
        this.zza = j;
        this.zzb = j2;
        this.zzc = z;
        this.zzd = str;
