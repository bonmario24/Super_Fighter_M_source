...
final class zzak extends zzae<String> {
    ...
    public final String zza(SharedPreferences sharedPreferences) {
        try {
            ...
            Log.e("PhenotypeFlag", valueOf.length() != 0 ? "Invalid string value in SharedPreferences for ".concat(valueOf) : new String("Invalid string value in SharedPreferences for "), classCastException);
            return null;
        }
    }
