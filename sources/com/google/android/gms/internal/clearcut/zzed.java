...
final class zzed {
    ...
    public final boolean next() {
        ...
        if (this.zzoa == zzcb.MAP.mo21749id()) {
            this.zznt++;
        } else if (this.zzoa >= zzcb.DOUBLE_LIST.mo21749id() && this.zzoa <= zzcb.GROUP_LIST.mo21749id()) {
            this.zznu++;
        }
        this.zznx++;
        ...
        if (zzda()) {
            ...
            if (this.zzoa == zzcb.MESSAGE.mo21749id() + 51 || this.zzoa == zzcb.GROUP.mo21749id() + 51) {
                this.zzoe = zzcw();
            } else if (this.zzoa == zzcb.ENUM.mo21749id() + 51 && zzcz()) {
                this.zzof = zzcw();
            }
        } else {
            ...
            if (this.zzoa == zzcb.MESSAGE.mo21749id() || this.zzoa == zzcb.GROUP.mo21749id()) {
                this.zzoe = this.zzod.getType();
            } else if (this.zzoa == zzcb.MESSAGE_LIST.mo21749id() || this.zzoa == zzcb.GROUP_LIST.mo21749id()) {
                this.zzoe = zzcw();
            } else if (this.zzoa == zzcb.ENUM.mo21749id() || this.zzoa == zzcb.ENUM_LIST.mo21749id() || this.zzoa == zzcb.ENUM_LIST_PACKED.mo21749id()) {
                if (zzcz()) {
                    this.zzof = zzcw();
                }
            } else if (this.zzoa == zzcb.MAP.mo21749id()) {
                this.zzog = zzcw();
                if ((this.zznz & 2048) != 0) {
                    z = true;
                }
    ...
    public final boolean zzda() {
        return this.zzoa > zzcb.MAP.mo21749id();
    }
    ...
    public final boolean zzde() {
        return zzcz() && this.zzoa <= zzcb.GROUP.mo21749id();
    }
