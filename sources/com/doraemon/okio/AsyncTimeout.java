    ...
    private static final class Watchdog extends Thread {
        ...
        public void run() {
            /*
                r3 = this;
            L_0x0000:
                java.lang.Class<com.doraemon.okio.AsyncTimeout> r2 = com.doraemon.okio.AsyncTimeout.class
                monitor-enter(r2)     // Catch:{ InterruptedException -> 0x000e }
                com.doraemon.okio.AsyncTimeout r0 = com.doraemon.okio.AsyncTimeout.awaitTimeout()     // Catch:{ all -> 0x000b }
            ...
            L_0x000e:
                ...
                goto L_0x0000
            L_0x0010:
                com.doraemon.okio.AsyncTimeout r1 = com.doraemon.okio.AsyncTimeout.head     // Catch:{ all -> 0x000b }
                if (r0 != r1) goto L_0x0019
                r1 = 0
                com.doraemon.okio.AsyncTimeout.head = r1     // Catch:{ all -> 0x000b }
                monitor-exit(r2)     // Catch:{ all -> 0x000b }
                return
            L_0x0019:
                monitor-exit(r2)     // Catch:{ all -> 0x000b }
                ...
                goto L_0x0000
            */
            throw new UnsupportedOperationException("Method not decompiled: com.doraemon.okio.AsyncTimeout.Watchdog.run():void");
        }
    }
