...
public final class Pipe {
    ...
    final class PipeSink implements Sink {
        ...
        public void write(com.doraemon.okio.Buffer r13, long r14) throws java.io.IOException {
            /*
                r12 = this;
                r10 = 0
                com.doraemon.okio.Pipe r4 = com.doraemon.okio.Pipe.this
                com.doraemon.okio.Buffer r5 = r4.buffer
                monitor-enter(r5)
                com.doraemon.okio.Pipe r4 = com.doraemon.okio.Pipe.this     // Catch:{ all -> 0x0015 }
            ...
            L_0x0018:
                ...
                com.doraemon.okio.Pipe r4 = com.doraemon.okio.Pipe.this     // Catch:{ all -> 0x0015 }
                com.doraemon.okio.Buffer r4 = r4.buffer     // Catch:{ all -> 0x0015 }
                long r8 = r4.size()     // Catch:{ all -> 0x0015 }
                long r0 = r6 - r8
                int r4 = (r0 > r10 ? 1 : (r0 == r10 ? 0 : -1))
                if (r4 != 0) goto L_0x0045
                com.doraemon.okio.Timeout r4 = r12.timeout     // Catch:{ all -> 0x0015 }
                com.doraemon.okio.Pipe r6 = com.doraemon.okio.Pipe.this     // Catch:{ all -> 0x0015 }
                com.doraemon.okio.Buffer r6 = r6.buffer     // Catch:{ all -> 0x0015 }
            ...
            L_0x0045:
                ...
                com.doraemon.okio.Pipe r4 = com.doraemon.okio.Pipe.this     // Catch:{ all -> 0x0015 }
                com.doraemon.okio.Buffer r4 = r4.buffer     // Catch:{ all -> 0x0015 }
                r4.write((com.doraemon.okio.Buffer) r13, (long) r2)     // Catch:{ all -> 0x0015 }
                long r14 = r14 - r2
                com.doraemon.okio.Pipe r4 = com.doraemon.okio.Pipe.this     // Catch:{ all -> 0x0015 }
                com.doraemon.okio.Buffer r4 = r4.buffer     // Catch:{ all -> 0x0015 }
            ...
            L_0x0059:
                ...
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.doraemon.okio.Pipe.PipeSink.write(com.doraemon.okio.Buffer, long):void");
        }
