...
import com.doraemon.okhttp3.internal.cache.CacheRequest;
import com.doraemon.okhttp3.internal.cache.CacheStrategy;
import com.doraemon.okhttp3.internal.cache.DiskLruCache;
...
public final class Cache implements Closeable, Flushable {
    ...
    private final class CacheRequestImpl implements CacheRequest {
        ...
        public void abort() {
            /*
                r3 = this;
                com.doraemon.okhttp3.Cache r1 = com.doraemon.okhttp3.Cache.this
                monitor-enter(r1)
            ...
            L_0x0009:
                ...
                com.doraemon.okhttp3.Cache r0 = com.doraemon.okhttp3.Cache.this     // Catch:{ all -> 0x0022 }
                int r2 = r0.writeAbortCount     // Catch:{ all -> 0x0022 }
                int r2 = r2 + 1
                r0.writeAbortCount = r2     // Catch:{ all -> 0x0022 }
                monitor-exit(r1)     // Catch:{ all -> 0x0022 }
                com.doraemon.okio.Sink r0 = r3.cacheOut
                com.doraemon.okhttp3.internal.Util.closeQuietly((java.io.Closeable) r0)
                com.doraemon.okhttp3.internal.cache.DiskLruCache$Editor r0 = r3.editor     // Catch:{ IOException -> 0x0020 }
            ...
            L_0x0022:
                ...
                throw r0
            */
            throw new UnsupportedOperationException("Method not decompiled: com.doraemon.okhttp3.Cache.CacheRequestImpl.abort():void");
        }
    ...
    private static final class Entry {
        ...
        Entry(Source in) throws IOException {
            try {
                ...
                if (isHttps()) {
                    ...
                    this.handshake = Handshake.get(!source.exhausted() ? TlsVersion.forJavaName(source.readUtf8LineStrict()) : TlsVersion.SSL_3_0, CipherSuite.forJavaName(source.readUtf8LineStrict()), readCertificateList(source), readCertificateList(source));
                } else {
                    this.handshake = null;
                }
            } finally {
        ...
        private void writeCertList(BufferedSink sink, List<Certificate> certificates) throws IOException {
            try {
                ...
                for (int i = 0; i < size; i++) {
                    sink.writeUtf8(ByteString.m17of(certificates.get(i).getEncoded()).base64()).writeByte(10);
                }
