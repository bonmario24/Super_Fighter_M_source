...
import com.doraemon.okhttp3.internal.http.HttpDate;
...
public final class Headers {
    ...
    public String toString() {
        ...
        int size = size();
        for (int i = 0; i < size; i++) {
            result.append(name(i)).append(": ").append(value(i)).append(ShellAdbUtil.COMMAND_LINE_END);
        }
    ...
    /* renamed from: of */
    public static Headers m15of(String... namesAndValues2) {
    ...
    /* renamed from: of */
    public static Headers m14of(Map<String, String> headers) {
        if (headers == null) {
