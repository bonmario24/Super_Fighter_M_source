package com.doraemon.okhttp3.internal.cache2;
...
final class Relay {
    ...
    class RelaySource implements Source {
        ...
        public long read(com.doraemon.okio.Buffer r29, long r30) throws java.io.IOException {
            /*
                r28 = this;
                r0 = r28
                com.doraemon.okhttp3.internal.cache2.FileOperator r4 = r0.fileOperator
            ...
            L_0x000e:
                r0 = r28
                com.doraemon.okhttp3.internal.cache2.Relay r10 = com.doraemon.okhttp3.internal.cache2.Relay.this
                monitor-enter(r10)
            L_0x0013:
                r0 = r28
                long r4 = r0.sourcePos     // Catch:{ all -> 0x0043 }
                r0 = r28
                com.doraemon.okhttp3.internal.cache2.Relay r6 = com.doraemon.okhttp3.internal.cache2.Relay.this     // Catch:{ all -> 0x0043 }
                long r0 = r6.upstreamPos     // Catch:{ all -> 0x0043 }
                r26 = r0
                int r4 = (r4 > r26 ? 1 : (r4 == r26 ? 0 : -1))
                if (r4 != 0) goto L_0x007f
                r0 = r28
                com.doraemon.okhttp3.internal.cache2.Relay r4 = com.doraemon.okhttp3.internal.cache2.Relay.this     // Catch:{ all -> 0x0043 }
            ...
            L_0x002f:
                ...
                r0 = r28
                com.doraemon.okio.Timeout r4 = r0.timeout     // Catch:{ all -> 0x0043 }
                r0 = r28
                com.doraemon.okhttp3.internal.cache2.Relay r5 = com.doraemon.okhttp3.internal.cache2.Relay.this     // Catch:{ all -> 0x0043 }
            ...
            L_0x007f:
                r0 = r28
                com.doraemon.okhttp3.internal.cache2.Relay r4 = com.doraemon.okhttp3.internal.cache2.Relay.this     // Catch:{ all -> 0x0043 }
                com.doraemon.okio.Buffer r4 = r4.buffer     // Catch:{ all -> 0x0043 }
            ...
            L_0x0097:
                ...
                long r6 = r6 - r22
                r5 = r29
                r4.copyTo((com.doraemon.okio.Buffer) r5, (long) r6, (long) r8)     // Catch:{ all -> 0x0043 }
                r0 = r28
                long r4 = r0.sourcePos     // Catch:{ all -> 0x0043 }
                long r4 = r4 + r8
                r0 = r28
            ...
            L_0x00c0:
                r0 = r28
                com.doraemon.okhttp3.internal.cache2.Relay r4 = com.doraemon.okhttp3.internal.cache2.Relay.this     // Catch:{ all -> 0x019e }
                com.doraemon.okio.Source r4 = r4.upstream     // Catch:{ all -> 0x019e }
                r0 = r28
                com.doraemon.okhttp3.internal.cache2.Relay r5 = com.doraemon.okhttp3.internal.cache2.Relay.this     // Catch:{ all -> 0x019e }
                com.doraemon.okio.Buffer r5 = r5.upstreamBuffer     // Catch:{ all -> 0x019e }
                r0 = r28
                com.doraemon.okhttp3.internal.cache2.Relay r6 = com.doraemon.okhttp3.internal.cache2.Relay.this     // Catch:{ all -> 0x019e }
                ...
                r8 = -1
                r0 = r28
                com.doraemon.okhttp3.internal.cache2.Relay r5 = com.doraemon.okhttp3.internal.cache2.Relay.this
                monitor-enter(r5)
                r0 = r28
                com.doraemon.okhttp3.internal.cache2.Relay r4 = com.doraemon.okhttp3.internal.cache2.Relay.this     // Catch:{ all -> 0x00fd }
                r6 = 0
            ...
            L_0x0100:
                ...
                r0 = r28
                com.doraemon.okhttp3.internal.cache2.Relay r4 = com.doraemon.okhttp3.internal.cache2.Relay.this     // Catch:{ all -> 0x019e }
                com.doraemon.okio.Buffer r10 = r4.upstreamBuffer     // Catch:{ all -> 0x019e }
                r12 = 0
                r11 = r29
                r10.copyTo((com.doraemon.okio.Buffer) r11, (long) r12, (long) r14)     // Catch:{ all -> 0x019e }
                r0 = r28
                ...
                r0 = r28
                com.doraemon.okhttp3.internal.cache2.FileOperator r0 = r0.fileOperator     // Catch:{ all -> 0x019e }
                r16 = r0
                r4 = 32
                long r17 = r4 + r26
                r0 = r28
                com.doraemon.okhttp3.internal.cache2.Relay r4 = com.doraemon.okhttp3.internal.cache2.Relay.this     // Catch:{ all -> 0x019e }
                com.doraemon.okio.Buffer r4 = r4.upstreamBuffer     // Catch:{ all -> 0x019e }
                com.doraemon.okio.Buffer r19 = r4.clone()     // Catch:{ all -> 0x019e }
                r16.write(r17, r19, r20)     // Catch:{ all -> 0x019e }
                r0 = r28
                com.doraemon.okhttp3.internal.cache2.Relay r5 = com.doraemon.okhttp3.internal.cache2.Relay.this     // Catch:{ all -> 0x019e }
                monitor-enter(r5)     // Catch:{ all -> 0x019e }
                r0 = r28
                com.doraemon.okhttp3.internal.cache2.Relay r4 = com.doraemon.okhttp3.internal.cache2.Relay.this     // Catch:{ all -> 0x019b }
                com.doraemon.okio.Buffer r4 = r4.buffer     // Catch:{ all -> 0x019b }
                r0 = r28
                com.doraemon.okhttp3.internal.cache2.Relay r6 = com.doraemon.okhttp3.internal.cache2.Relay.this     // Catch:{ all -> 0x019b }
                com.doraemon.okio.Buffer r6 = r6.upstreamBuffer     // Catch:{ all -> 0x019b }
                r0 = r20
                r4.write((com.doraemon.okio.Buffer) r6, (long) r0)     // Catch:{ all -> 0x019b }
                r0 = r28
                com.doraemon.okhttp3.internal.cache2.Relay r4 = com.doraemon.okhttp3.internal.cache2.Relay.this     // Catch:{ all -> 0x019b }
                com.doraemon.okio.Buffer r4 = r4.buffer     // Catch:{ all -> 0x019b }
                ...
                r0 = r28
                com.doraemon.okhttp3.internal.cache2.Relay r6 = com.doraemon.okhttp3.internal.cache2.Relay.this     // Catch:{ all -> 0x019b }
                com.doraemon.okio.Buffer r6 = r6.buffer     // Catch:{ all -> 0x019b }
                long r6 = r6.size()     // Catch:{ all -> 0x019b }
                r0 = r28
                com.doraemon.okhttp3.internal.cache2.Relay r10 = com.doraemon.okhttp3.internal.cache2.Relay.this     // Catch:{ all -> 0x019b }
            ...
            L_0x0179:
                ...
                monitor-enter(r5)
                r0 = r28
                com.doraemon.okhttp3.internal.cache2.Relay r4 = com.doraemon.okhttp3.internal.cache2.Relay.this     // Catch:{ all -> 0x01b4 }
                r6 = 0
            ...
            L_0x019e:
                ...
                monitor-enter(r5)
                r0 = r28
                com.doraemon.okhttp3.internal.cache2.Relay r6 = com.doraemon.okhttp3.internal.cache2.Relay.this     // Catch:{ all -> 0x01b7 }
                r7 = 0
            ...
            L_0x01b7:
                ...
                throw r4
            */
            throw new UnsupportedOperationException("Method not decompiled: com.doraemon.okhttp3.internal.cache2.Relay.RelaySource.read(com.doraemon.okio.Buffer, long):long");
        }
