package com.doraemon.okhttp3.internal.http1;
...
import com.doraemon.okio.ForwardingTimeout;
...
public final class Http1Codec implements HttpCodec {
    ...
    public ResponseBody openResponseBody(Response response) throws IOException {
        ...
        String contentType = response.header(HttpHeaders.HEAD_KEY_CONTENT_TYPE);
        if (!com.doraemon.okhttp3.internal.http.HttpHeaders.hasBody(response)) {
        ...
        long contentLength = com.doraemon.okhttp3.internal.http.HttpHeaders.contentLength(response);
        if (contentLength != -1) {
        ...
        private void readChunkSize() throws IOException {
            ...
            try {
                ...
                if (this.bytesRemainingInChunk < 0 || (!extensions.isEmpty() && !extensions.startsWith(";"))) {
                    ...
                    com.doraemon.okhttp3.internal.http.HttpHeaders.receiveHeaders(Http1Codec.this.client.cookieJar(), this.url, Http1Codec.this.readHeaders());
                    endOfInput(true, (IOException) null);
                }
