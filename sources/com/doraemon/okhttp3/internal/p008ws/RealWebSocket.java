package com.doraemon.okhttp3.internal.p008ws;
...
import com.doraemon.okhttp3.WebSocket;
import com.doraemon.okhttp3.WebSocketListener;
...
import com.doraemon.okhttp3.internal.p008ws.WebSocketReader;
...
/* renamed from: com.doraemon.okhttp3.internal.ws.RealWebSocket */
public final class RealWebSocket implements WebSocket, WebSocketReader.FrameCallback {
    ...
    public RealWebSocket(Request request, WebSocketListener listener2, Random random2, long pingIntervalMillis2) {
        ...
        this.key = ByteString.m17of(nonce).base64();
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:18:0x004b, code lost:
        com.doraemon.okhttp3.internal.Util.closeQuietly((java.io.Closeable) r9);
     */
    /* JADX WARNING: Code restructure failed: missing block: B:30:0x0075, code lost:
        if ((r4 instanceof com.doraemon.okhttp3.internal.p008ws.RealWebSocket.Message) == false) goto L_0x00ad;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:31:0x0077, code lost:
        r3 = ((com.doraemon.okhttp3.internal.p008ws.RealWebSocket.Message) r4).data;
        r8 = com.doraemon.okio.Okio.buffer(r10.newMessageSink(((com.doraemon.okhttp3.internal.p008ws.RealWebSocket.Message) r4).formatOpcode, (long) r3.size()));
        r8.write(r3);
        r8.close();
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:47:0x00af, code lost:
        if ((r4 instanceof com.doraemon.okhttp3.internal.p008ws.RealWebSocket.Close) == false) goto L_0x00c8;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:48:0x00b1, code lost:
        r2 = (com.doraemon.okhttp3.internal.p008ws.RealWebSocket.Close) r4;
    ...
    public boolean writeOneFrame() throws java.io.IOException {
        ...
        L_0x000e:
            r0 = r16
            com.doraemon.okhttp3.internal.ws.WebSocketWriter r10 = r0.writer     // Catch:{ all -> 0x006c }
            r0 = r16
            java.util.ArrayDeque<com.doraemon.okio.ByteString> r12 = r0.pongQueue     // Catch:{ all -> 0x006c }
            java.lang.Object r5 = r12.poll()     // Catch:{ all -> 0x006c }
            com.doraemon.okio.ByteString r5 = (com.doraemon.okio.ByteString) r5     // Catch:{ all -> 0x006c }
            ...
            boolean r12 = r4 instanceof com.doraemon.okhttp3.internal.p008ws.RealWebSocket.Close     // Catch:{ all -> 0x006c }
            ...
            r0 = r16
            com.doraemon.okhttp3.internal.ws.RealWebSocket$Streams r9 = r0.streams     // Catch:{ all -> 0x006c }
            r11 = 0
            r0 = r16
        ...
        L_0x0050:
            ...
            com.doraemon.okhttp3.internal.ws.RealWebSocket$CancelRunnable r13 = new com.doraemon.okhttp3.internal.ws.RealWebSocket$CancelRunnable     // Catch:{ all -> 0x006c }
            r0 = r16
            r13.<init>()     // Catch:{ all -> 0x006c }
            r0 = r4
            com.doraemon.okhttp3.internal.ws.RealWebSocket$Close r0 = (com.doraemon.okhttp3.internal.p008ws.RealWebSocket.Close) r0     // Catch:{ all -> 0x006c }
            r11 = r0
        ...
        L_0x006f:
            ...
            goto L_0x000d
        L_0x0073:
            boolean r11 = r4 instanceof com.doraemon.okhttp3.internal.p008ws.RealWebSocket.Message     // Catch:{ all -> 0x00a8 }
            if (r11 == 0) goto L_0x00ad
            r0 = r4
            com.doraemon.okhttp3.internal.ws.RealWebSocket$Message r0 = (com.doraemon.okhttp3.internal.p008ws.RealWebSocket.Message) r0     // Catch:{ all -> 0x00a8 }
            r11 = r0
            com.doraemon.okio.ByteString r3 = r11.data     // Catch:{ all -> 0x00a8 }
            com.doraemon.okhttp3.internal.ws.RealWebSocket$Message r4 = (com.doraemon.okhttp3.internal.p008ws.RealWebSocket.Message) r4     // Catch:{ all -> 0x00a8 }
            int r11 = r4.formatOpcode     // Catch:{ all -> 0x00a8 }
            int r12 = r3.size()     // Catch:{ all -> 0x00a8 }
            long r12 = (long) r12     // Catch:{ all -> 0x00a8 }
            com.doraemon.okio.Sink r11 = r10.newMessageSink(r11, r12)     // Catch:{ all -> 0x00a8 }
            com.doraemon.okio.BufferedSink r8 = com.doraemon.okio.Okio.buffer((com.doraemon.okio.Sink) r11)     // Catch:{ all -> 0x00a8 }
            r8.write((com.doraemon.okio.ByteString) r3)     // Catch:{ all -> 0x00a8 }
        ...
        L_0x00a8:
            ...
            throw r11
        L_0x00ad:
            boolean r11 = r4 instanceof com.doraemon.okhttp3.internal.p008ws.RealWebSocket.Close     // Catch:{ all -> 0x00a8 }
            if (r11 == 0) goto L_0x00c8
            r0 = r4
            com.doraemon.okhttp3.internal.ws.RealWebSocket$Close r0 = (com.doraemon.okhttp3.internal.p008ws.RealWebSocket.Close) r0     // Catch:{ all -> 0x00a8 }
            r2 = r0
            int r11 = r2.code     // Catch:{ all -> 0x00a8 }
            com.doraemon.okio.ByteString r12 = r2.reason     // Catch:{ all -> 0x00a8 }
            r10.writeClose(r11, r12)     // Catch:{ all -> 0x00a8 }
            if (r9 == 0) goto L_0x004b
            r0 = r16
            com.doraemon.okhttp3.WebSocketListener r11 = r0.listener     // Catch:{ all -> 0x00a8 }
            r0 = r16
        ...
        L_0x00c8:
            ...
            throw r11     // Catch:{ all -> 0x00a8 }
        */
        throw new UnsupportedOperationException("Method not decompiled: com.doraemon.okhttp3.internal.p008ws.RealWebSocket.writeOneFrame():boolean");
    }

    /* renamed from: com.doraemon.okhttp3.internal.ws.RealWebSocket$PingRunnable */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:12:0x001d, code lost:
        failWebSocket(new java.net.SocketTimeoutException("sent ping but didn't receive pong within " + r9.pingIntervalMillis + "ms (after " + (r1 - 1) + " successful ping/pongs)"), (com.doraemon.okhttp3.Response) null);
     */
    /* JADX WARNING: Code restructure failed: missing block: B:19:?, code lost:
        r2.writePing(com.doraemon.okio.ByteString.EMPTY);
     */
    /* JADX WARNING: Code restructure failed: missing block: B:20:0x0058, code lost:
        r0 = move-exception;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:21:0x0059, code lost:
        failWebSocket(r0, (com.doraemon.okhttp3.Response) null);
     */
    ...
    public void writePingFrame() {
        ...
        L_0x0008:
            return
        L_0x0009:
            com.doraemon.okhttp3.internal.ws.WebSocketWriter r2 = r9.writer     // Catch:{ all -> 0x004f }
        ...
        L_0x004f:
            ...
            throw r3
        L_0x0052:
            com.doraemon.okio.ByteString r3 = com.doraemon.okio.ByteString.EMPTY     // Catch:{ IOException -> 0x0058 }
        ...
        L_0x0058:
            ...
            goto L_0x0008
        */
        throw new UnsupportedOperationException("Method not decompiled: com.doraemon.okhttp3.internal.p008ws.RealWebSocket.writePingFrame():void");
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:20:0x0030, code lost:
        com.doraemon.okhttp3.internal.Util.closeQuietly((java.io.Closeable) r0);
     */
     ...
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public void failWebSocket(java.lang.Exception r4, @com.doraemon.ext.Nullable com.doraemon.okhttp3.Response r5) {
        /*
            r3 = this;
            monitor-enter(r3)
        ...
        L_0x0007:
            ...
            com.doraemon.okhttp3.internal.ws.RealWebSocket$Streams r0 = r3.streams     // Catch:{ all -> 0x002c }
            r1 = 0
        ...
        L_0x0022:
            monitor-exit(r3)     // Catch:{ all -> 0x002c }
            com.doraemon.okhttp3.WebSocketListener r1 = r3.listener     // Catch:{ all -> 0x002f }
        ...
        L_0x002f:
            ...
            throw r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.doraemon.okhttp3.internal.p008ws.RealWebSocket.failWebSocket(java.lang.Exception, com.doraemon.okhttp3.Response):void");
    }

    /* renamed from: com.doraemon.okhttp3.internal.ws.RealWebSocket$Message */
    ...
    /* renamed from: com.doraemon.okhttp3.internal.ws.RealWebSocket$Close */
    ...
    /* renamed from: com.doraemon.okhttp3.internal.ws.RealWebSocket$Streams */
    ...
    /* renamed from: com.doraemon.okhttp3.internal.ws.RealWebSocket$CancelRunnable */
