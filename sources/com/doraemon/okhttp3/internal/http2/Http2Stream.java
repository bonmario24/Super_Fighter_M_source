...
import com.doraemon.okio.AsyncTimeout;
...
public final class Http2Stream {
    ...
    public void sendResponseHeaders(List<Header> responseHeaders2, boolean out) throws IOException {
        ...
        if (!$assertionsDisabled && Thread.holdsLock(this)) {
            ...
            this.connection.writeSynReply(this.f74id, outFinished, responseHeaders2);
            if (flushHeaders) {
    ...
    public void close(ErrorCode rstStatusCode) throws IOException {
        if (closeInternal(rstStatusCode)) {
            this.connection.writeSynReset(this.f74id, rstStatusCode);
        }
    }

    public void closeLater(ErrorCode errorCode2) {
        if (closeInternal(errorCode2)) {
            this.connection.writeSynResetLater(this.f74id, errorCode2);
        }
    }
    ...
    private boolean closeInternal(ErrorCode errorCode2) {
        if ($assertionsDisabled || !Thread.holdsLock(this)) {
            synchronized (this) {
                ...
                notifyAll();
                this.connection.removeStream(this.f74id);
                return true;
            }
        }
        throw new AssertionError();
        ...
        public long read(Buffer sink, long byteCount) throws IOException {
            ...
            synchronized (Http2Stream.this) {
                ...
                if (errorCode == null && Http2Stream.this.unacknowledgedBytesRead >= ((long) (Http2Stream.this.connection.okHttpSettings.getInitialWindowSize() / 2))) {
                    Http2Stream.this.connection.writeWindowUpdateLater(Http2Stream.this.f74id, Http2Stream.this.unacknowledgedBytesRead);
    ...
    final class FramingSink implements Sink {
        ...
        private void emitFrame(boolean outFinished) throws IOException {
            ...
            Http2Stream.this.writeTimeout.enter();
            try {
                Http2Stream.this.connection.writeData(Http2Stream.this.f74id, outFinished && toWrite == this.sendBuffer.size(), this.sendBuffer, toWrite);
            } finally {
                Http2Stream.this.writeTimeout.exitAndThrowIfTimedOut();
            }
        }
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:24:0x0042, code lost:
            r6.this$0.connection.writeData(r6.this$0.f74id, true, (com.doraemon.okio.Buffer) null, 0);
         */
        ...
        public void close() throws java.io.IOException {
            /*
                ...
                com.doraemon.okhttp3.internal.http2.Http2Stream r0 = com.doraemon.okhttp3.internal.http2.Http2Stream.this
                ...
                throw r0
            L_0x0015:
                com.doraemon.okhttp3.internal.http2.Http2Stream r1 = com.doraemon.okhttp3.internal.http2.Http2Stream.this
                monitor-enter(r1)
            ...
            L_0x001e:
                monitor-exit(r1)     // Catch:{ all -> 0x003f }
                com.doraemon.okhttp3.internal.http2.Http2Stream r0 = com.doraemon.okhttp3.internal.http2.Http2Stream.this
                com.doraemon.okhttp3.internal.http2.Http2Stream$FramingSink r0 = r0.sink
                boolean r0 = r0.finished
                if (r0 != 0) goto L_0x004e
                com.doraemon.okio.Buffer r0 = r6.sendBuffer
                long r0 = r0.size()
            ...
            L_0x0042:
                com.doraemon.okhttp3.internal.http2.Http2Stream r0 = com.doraemon.okhttp3.internal.http2.Http2Stream.this
                com.doraemon.okhttp3.internal.http2.Http2Connection r0 = r0.connection
                com.doraemon.okhttp3.internal.http2.Http2Stream r1 = com.doraemon.okhttp3.internal.http2.Http2Stream.this
                int r1 = r1.f74id
                r3 = 0
            ...
            L_0x0062:
                ...
                throw r0
            */
            throw new UnsupportedOperationException("Method not decompiled: com.doraemon.okhttp3.internal.http2.Http2Stream.FramingSink.close():void");
        }
    }
