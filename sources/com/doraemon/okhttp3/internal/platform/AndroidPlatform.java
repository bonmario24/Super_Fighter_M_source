package com.doraemon.okhttp3.internal.platform;
...
import com.doraemon.okhttp3.internal.tls.CertificateChainCleaner;
import com.doraemon.okhttp3.internal.tls.TrustRootIndex;
...
class AndroidPlatform extends Platform {
    ...
    static final class AndroidCertificateChainCleaner extends CertificateChainCleaner {
        ...
        public List<Certificate> clean(List<Certificate> chain, String hostname) throws SSLPeerUnverifiedException {
            try {
                return (List) this.checkServerTrusted.invoke(this.x509TrustManagerExtensions, new Object[]{(X509Certificate[]) chain.toArray(new X509Certificate[chain.size()]), RSAUtils.KEY_ALGORITHM, hostname});
