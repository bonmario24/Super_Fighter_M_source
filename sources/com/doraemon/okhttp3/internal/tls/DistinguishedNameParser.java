package com.doraemon.okhttp3.internal.tls;
...
final class DistinguishedNameParser {
    ...
    /* renamed from: dn */
    private final String f75dn;
    private int end;
    private final int length = this.f75dn.length();
    private int pos;

    DistinguishedNameParser(X500Principal principal) {
        this.f75dn = principal.getName("RFC2253");
    }
    ...
    private String nextAT() {
        ...
        if (this.pos >= this.length) {
            throw new IllegalStateException("Unexpected end of DN: " + this.f75dn);
        }
        this.end = this.pos;
    ...
    private int getByte(int position) {
        ...
        if (position + 1 >= this.length) {
            throw new IllegalStateException("Malformed DN: " + this.f75dn);
        }
    ...
    public String findMostSpecific(String attributeType) {
        ...
        this.end = 0;
        this.cur = 0;
        this.chars = this.f75dn.toCharArray();
