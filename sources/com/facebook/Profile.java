...
public final class Profile implements Parcelable {
    ...
    public Uri getProfilePictureUri(int width, int height) {
        return ImageRequest.getProfilePictureUri(this.f830id, width, height, AccessToken.isCurrentAccessTokenActive() ? AccessToken.getCurrentAccessToken().getToken() : "");
    }
    ...
    public boolean equals(Object other) {
        ...
        if (!this.f830id.equals(o.f830id) || this.firstName != null) {
    ...
    public int hashCode() {
        int result = this.f830id.hashCode() + 527;
    ...
    Profile(JSONObject jsonObject) {
        Uri uri = null;
        this.f830id = jsonObject.optString("id", (String) null);
