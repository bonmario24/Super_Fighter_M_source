...
public class GraphResponse {
    ...
    public String toString() {
        ...
        try {
            ...
            objArr[0] = Integer.valueOf(this.connection != null ? this.connection.getResponseCode() : HttpResponse.f88OK);
    ...
    private static List<GraphResponse> createResponsesFromObject(HttpURLConnection connection2, List<GraphRequest> requests, Object object) throws FacebookException, JSONException {
        ...
        if (numRequests == 1) {
            ...
            try {
                ...
                jsonObject.put(CODE_KEY, connection2 != null ? connection2.getResponseCode() : HttpResponse.f88OK);
