...
public abstract class FacebookButtonBase extends Button {
    ...
    protected FacebookButtonBase(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes, String analyticsButtonCreatedEventName2, String analyticsButtonTappedEventName2) {
        ...
        configureButton(context, attrs, defStyleAttr, defStyleRes == 0 ? C1278R.style.com_facebook_button : defStyleRes);
        ...
        if (!isInEditMode()) {
            ...
            try {
                if (a.hasValue(0)) {
                    ...
                    setBackgroundColor(ContextCompat.getColor(context, C1278R.color.com_facebook_blue));
                }
            } finally {
                a.recycle();
            }
