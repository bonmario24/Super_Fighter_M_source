...
public final class Utility {
    ...
    public static void setAppEventExtendedDeviceInfoParameters(JSONObject params, Context appContext) throws JSONException {
        ...
        params.put(Constants.EXTINFO, extraInfoArray.toString());
    }
    ...
    public static class PermissionsLists {
        ...
        public PermissionsLists(List<String> grantedPermissions2, List<String> declinedPermissions2, List<String> expiredPermissions2) {
            this.grantedPermissions = grantedPermissions2;
            this.declinedPermissions = declinedPermissions2;
            this.expiredPermissions = expiredPermissions2;
        }
