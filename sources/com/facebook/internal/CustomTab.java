...
public class CustomTab {
    ...
    public CustomTab(String action, Bundle parameters) {
        this.uri = Utility.buildUri(ServerProtocol.getDialogAuthority(), FacebookSdk.getGraphApiVersion() + "/" + ServerProtocol.DIALOG_PATH + action, parameters == null ? new Bundle() : parameters);
    }
