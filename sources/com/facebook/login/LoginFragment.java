...
public class LoginFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        final View progressBar = view.findViewById(C1278R.C1281id.com_facebook_login_fragment_progress_bar);
    ...
    public int getLayoutResId() {
        return C1278R.layout.com_facebook_login_fragment;
    }
    ...
    public void onPause() {
        ...
        if (getView() == null) {
            ...
            progressBar = getView().findViewById(C1278R.C1281id.com_facebook_login_fragment_progress_bar);
        }
        if (progressBar != null) {
            progressBar.setVisibility(8);
        }
