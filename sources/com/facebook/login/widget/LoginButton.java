...
public class LoginButton extends FacebookButtonBase {
    ...
    public void setLoginText(String loginText2) {
        this.loginText = loginText2;
        setButtonText();
    }

    public void setLogoutText(String logoutText2) {
        this.logoutText = logoutText2;
        setButtonText();
    }
    ...
    public void configureButton(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        if (isInEditMode()) {
            setBackgroundColor(getResources().getColor(C1278R.color.com_facebook_blue));
