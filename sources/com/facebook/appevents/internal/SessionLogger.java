...
class SessionLogger {
    ...
    public static void logActivateApp(String activityName, SourceApplicationInfo sourceApplicationInfo, String appId) {
        ...
        InternalAppEventsLogger logger = new InternalAppEventsLogger(activityName, appId, (AccessToken) null);
    ...
    public static void logDeactivateApp(String activityName, SessionInfo sessionInfo, String appId) {
        ...
        new InternalAppEventsLogger(activityName, appId, (AccessToken) null).logEvent(AppEventsConstants.EVENT_NAME_DEACTIVATED_APP, ((double) sessionLength.longValue()) / 1000.0d, eventParams);
    }
