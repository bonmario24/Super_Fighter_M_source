...
public class EventBinding {
    ...
    public static EventBinding getInstanceFromJson(JSONObject mapping) throws JSONException, IllegalArgumentException {
        ...
        MappingMethod method2 = MappingMethod.valueOf(mapping.getString(FirebaseAnalytics.Param.METHOD).toUpperCase(Locale.ENGLISH));
        ActionType type2 = ActionType.valueOf(mapping.getString("event_type").toUpperCase(Locale.ENGLISH));
