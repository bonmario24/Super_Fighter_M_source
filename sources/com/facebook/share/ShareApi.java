...
public final class ShareApi {
    ...
    private void sharePhotoContent(SharePhotoContent photoContent, FacebookCallback<Sharer.Result> callback) {
        ...
        final FacebookCallback<Sharer.Result> facebookCallback = callback;
        C13773 r3 = new GraphRequest.Callback() {
            public void onCompleted(GraphResponse response) {
            ...
            for (SharePhoto photo : photoContent.getPhotos()) {
                try {
                    ...
                    if (bitmap != null) {
                        ...
                        arrayList.add(GraphRequest.newUploadPhotoRequest(accessToken, getGraphPath(PHOTOS_EDGE), bitmap, caption, params, (GraphRequest.Callback) r3));
                    } else if (photoUri != null) {
                        ArrayList<GraphRequest> arrayList2 = requests;
                        arrayList2.add(GraphRequest.newUploadPhotoRequest(accessToken, getGraphPath(PHOTOS_EDGE), photoUri, caption, params, (GraphRequest.Callback) r3));
                    }
                } catch (JSONException e) {
