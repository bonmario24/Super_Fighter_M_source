...
public class DeviceShareDialogFragment extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        View view = getActivity().getLayoutInflater().inflate(C1278R.layout.com_facebook_device_auth_dialog_fragment, (ViewGroup) null);
        this.progressBar = (ProgressBar) view.findViewById(C1278R.C1281id.progress_bar);
        ...
        ((TextView) view.findViewById(C1278R.C1281id.com_facebook_device_auth_instructions)).setText(Html.fromHtml(getString(C1278R.string.com_facebook_device_auth_instructions)));
