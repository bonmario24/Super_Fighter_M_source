...
public class FacebookActivity extends FragmentActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(C1278R.layout.com_facebook_activity_layout);
    ...
    public Fragment getFragment() {
        ...
        if (FacebookDialogFragment.TAG.equals(intent.getAction())) {
            ...
            dialogFragment2.setShareContent((ShareContent) intent.getParcelableExtra(FirebaseAnalytics.Param.CONTENT));
            dialogFragment2.show(manager, FRAGMENT_TAG);
            return dialogFragment2;
        } else {
            Fragment fragment2 = new LoginFragment();
            fragment2.setRetainInstance(true);
            manager.beginTransaction().add(C1278R.C1281id.com_facebook_fragment_container, fragment2, FRAGMENT_TAG).commit();
            return fragment2;
        }
    }
