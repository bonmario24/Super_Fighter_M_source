...
public final class FacebookSdk {
    ...
    public static synchronized void sdkInitialize(final Context applicationContext2, final InitializeCallback callback) {
        synchronized (FacebookSdk.class) {
            if (!sdkInitialized.booleanValue()) {
                ...
                AppEventsLogger.getAnonymousAppDeviceGUID(applicationContext2);
    ...
    static void publishInstallAndWaitForResponse(android.content.Context r14, java.lang.String r15) {
        ...
        L_0x0013:
            ...
            com.facebook.appevents.internal.AppEventsLoggerUtility$GraphAPIActivityType r11 = com.facebook.appevents.internal.AppEventsLoggerUtility.GraphAPIActivityType.MOBILE_INSTALL_EVENT     // Catch:{ JSONException -> 0x0076 }
            java.lang.String r12 = com.facebook.appevents.AppEventsLogger.getAnonymousAppDeviceGUID(r14)     // Catch:{ JSONException -> 0x0076 }
            boolean r13 = getLimitEventAndDataUsage(r14)     // Catch:{ JSONException -> 0x0076 }
            org.json.JSONObject r7 = com.facebook.appevents.internal.AppEventsLoggerUtility.getJSONObjectForGraphAPICall(r11, r2, r12, r13, r14)     // Catch:{ JSONException -> 0x0076 }
            ...
            com.facebook.FacebookRequestError r11 = r9.getError()     // Catch:{ Exception -> 0x000c }
            if (r11 != 0) goto L_0x0012
