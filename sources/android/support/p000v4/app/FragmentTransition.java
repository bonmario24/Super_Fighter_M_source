...
class FragmentTransition {
    ...
    private static void addToFirstInLastOut(BackStackRecord transaction, BackStackRecord.C0002Op op, SparseArray<FragmentContainerTransition> transitioningFragments, boolean isPop, boolean isReorderedTransaction) {
        int containerId;
        boolean setFirstOut;
        boolean setLastIn;
