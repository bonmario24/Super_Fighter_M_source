...
public class FontsContractCompat {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:40:0x0094, code lost:
        sBackgroundThread.postAndReply(r2, new android.support.p000v4.provider.FontsContractCompat.C01083());
     */
    ...
    public static class FontInfo {
        ...
        @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP})
        public FontInfo(@NonNull Uri uri, @IntRange(from = 0) int ttcIndex, @IntRange(from = 1, mo13859to = 1000) int weight, boolean italic, int resultCode) {
        ...
        @IntRange(from = 1, mo13859to = 1000)
