...
public class AjTypeImpl<T> implements AjType<T> {
    ...
    private org.aspectj.lang.reflect.Pointcut asPointcut(java.lang.reflect.Method r10) {
        /*
            r9 = this;
            ...
            org.aspectj.lang.annotation.Pointcut r8 = (org.aspectj.lang.annotation.Pointcut) r8
        ...
        L_0x0034:
            ...
            org.aspectj.lang.reflect.AjType r4 = org.aspectj.lang.reflect.AjTypeSystem.getAjType(r3)
