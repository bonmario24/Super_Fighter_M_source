...
public final class RealWebSocket implements WebSocket, WebSocketReader.FrameCallback {
    ...
    public RealWebSocket(Request request, WebSocketListener listener2, Random random2, long pingIntervalMillis2) {
        ...
        this.key = ByteString.m187of(nonce).base64();
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:30:0x0075, code lost:
        if ((r4 instanceof okhttp3.internal.p010ws.RealWebSocket.Message) == false) goto L_0x00ad;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:31:0x0077, code lost:
        r3 = ((okhttp3.internal.p010ws.RealWebSocket.Message) r4).data;
        r8 = okio.Okio.buffer(r10.newMessageSink(((okhttp3.internal.p010ws.RealWebSocket.Message) r4).formatOpcode, (long) r3.size()));
        r8.write(r3);
        r8.close();
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:47:0x00af, code lost:
        if ((r4 instanceof okhttp3.internal.p010ws.RealWebSocket.Close) == false) goto L_0x00c8;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:48:0x00b1, code lost:
        r2 = (okhttp3.internal.p010ws.RealWebSocket.Close) r4;
    ...
    public boolean writeOneFrame() throws java.io.IOException {
        ...
        L_0x000e:
            ...
            boolean r12 = r4 instanceof okhttp3.internal.p010ws.RealWebSocket.Close     // Catch:{ all -> 0x006c }
        ...
        L_0x0050:
            ...
            r0 = r4
            okhttp3.internal.ws.RealWebSocket$Close r0 = (okhttp3.internal.p010ws.RealWebSocket.Close) r0     // Catch:{ all -> 0x006c }
            r11 = r0
        ...
        L_0x006f:
            ...
            goto L_0x000d
        L_0x0073:
            boolean r11 = r4 instanceof okhttp3.internal.p010ws.RealWebSocket.Message     // Catch:{ all -> 0x00a8 }
            if (r11 == 0) goto L_0x00ad
            r0 = r4
            okhttp3.internal.ws.RealWebSocket$Message r0 = (okhttp3.internal.p010ws.RealWebSocket.Message) r0     // Catch:{ all -> 0x00a8 }
            r11 = r0
            okio.ByteString r3 = r11.data     // Catch:{ all -> 0x00a8 }
            okhttp3.internal.ws.RealWebSocket$Message r4 = (okhttp3.internal.p010ws.RealWebSocket.Message) r4     // Catch:{ all -> 0x00a8 }
        ...
        L_0x00a8:
            ...
            throw r11
        L_0x00ad:
            boolean r11 = r4 instanceof okhttp3.internal.p010ws.RealWebSocket.Close     // Catch:{ all -> 0x00a8 }
            if (r11 == 0) goto L_0x00c8
            r0 = r4
            okhttp3.internal.ws.RealWebSocket$Close r0 = (okhttp3.internal.p010ws.RealWebSocket.Close) r0     // Catch:{ all -> 0x00a8 }
            r2 = r0
