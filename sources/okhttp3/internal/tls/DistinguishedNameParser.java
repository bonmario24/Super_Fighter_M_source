...
final class DistinguishedNameParser {
    ...
    /* renamed from: dn */
    private final String f329dn;
    private int end;
    private final int length = this.f329dn.length();
    private int pos;

    DistinguishedNameParser(X500Principal principal) {
        this.f329dn = principal.getName("RFC2253");
    }
    ...
    private String nextAT() {
        ...
        if (this.pos >= this.length) {
            throw new IllegalStateException("Unexpected end of DN: " + this.f329dn);
        }
        this.end = this.pos;
    ...
    private int getByte(int position) {
        ...
        if (position + 1 >= this.length) {
            throw new IllegalStateException("Malformed DN: " + this.f329dn);
        }
    ...
    public String findMostSpecific(String attributeType) {
        ...
        this.end = 0;
        this.cur = 0;
        this.chars = this.f329dn.toCharArray();
