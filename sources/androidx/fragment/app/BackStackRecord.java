...
final class BackStackRecord extends FragmentTransaction implements FragmentManager.BackStackEntry, FragmentManagerImpl.OpGenerator {
    ...
    public void dump(String prefix, PrintWriter writer, boolean full) {
        ...
        if (!this.mOps.isEmpty()) {
            ...
            for (int opNum = 0; opNum < numOps; opNum++) {
                FragmentTransaction.C0374Op op = (FragmentTransaction.C0374Op) this.mOps.get(opNum);
                switch (op.mCmd) {
                    case 0:
                        cmdStr = "NULL";
                        break;
            ...
            if (!(container == 0 || container == lastContainer)) {
                ...
                for (int i = startIndex; i < endIndex; i++) {
                    ...
                    for (int thoseOpIndex = 0; thoseOpIndex < numThoseOps; thoseOpIndex++) {
                        FragmentTransaction.C0374Op thatOp = (FragmentTransaction.C0374Op) record.mOps.get(thoseOpIndex);
            ...
            switch (op.mCmd) {
                        ...
                        if (old.mContainerId == containerId) {
                            if (old == f) {
                                ...
                                if (old == oldPrimaryNav) {
                                    this.mOps.add(opNum, new FragmentTransaction.C0374Op(9, old));
                                    opNum++;
                                    oldPrimaryNav = null;
                                }
                                FragmentTransaction.C0374Op removeOp = new FragmentTransaction.C0374Op(3, old);
                ...
                case 6:
                    ...
                    if (op.mFragment != oldPrimaryNav) {
                        ...
                        this.mOps.add(opNum, new FragmentTransaction.C0374Op(9, op.mFragment));
                        opNum++;
                        oldPrimaryNav = null;
                        break;
                    }
                case 8:
                    this.mOps.add(opNum, new FragmentTransaction.C0374Op(9, oldPrimaryNav));
                    opNum++;
    ...
    public boolean isPostponed() {
        for (int opNum = 0; opNum < this.mOps.size(); opNum++) {
            if (isFragmentPostponed((FragmentTransaction.C0374Op) this.mOps.get(opNum))) {
                return true;
            }
        }
        return false;
    ...
    private static boolean isFragmentPostponed(FragmentTransaction.C0374Op op) {
