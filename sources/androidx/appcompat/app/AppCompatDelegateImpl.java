...
class AppCompatDelegateImpl extends AppCompatDelegate implements MenuBuilder.Callback, LayoutInflater.Factory2 {
    ...
    private boolean applyDayNight(boolean allowRecreation) {
        ...
        boolean updateForNightMode = updateForNightMode(mapNightMode(nightMode), allowRecreation);
        if (nightMode == 0) {
    ...
    private boolean updateForNightMode(int mode, boolean allowRecreation) {
        ...
        if (!handled && currentNightMode != newNightMode && allowRecreation && !activityHandlingUiMode && this.mBaseContextAttached && ((Build.VERSION.SDK_INT >= 17 || this.mCreated) && (this.mHost instanceof Activity))) {
        ...
        if (handled && (this.mHost instanceof AppCompatActivity)) {
            ((AppCompatActivity) this.mHost).onNightModeChanged(mode);
        }
        return handled;
    }
    ...
    private boolean isActivityManifestHandlingUiMode() {
        ...
        if (!this.mActivityHandlesUiModeChecked && (this.mHost instanceof Activity)) {
            ...
            try {
                ...
                if (info == null || (info.configChanges & 512) == 0) {
                    z = false;
                } else {
                    z = true;
                }
