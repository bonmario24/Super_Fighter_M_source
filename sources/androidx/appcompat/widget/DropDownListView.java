...
class DropDownListView extends ListView {
    ...
    /* JADX WARNING: type inference failed for: r1v2, types: [androidx.appcompat.widget.DropDownListView$GateKeeperDrawable, android.graphics.drawable.Drawable] */
    ...
    private static class GateKeeperDrawable extends DrawableWrapper {
        ...
        public boolean setState(int[] stateSet) {
            if (this.mEnabled) {
                return DropDownListView.super.setState(stateSet);
            }
            return false;
        }
        ...
        public void draw(Canvas canvas) {
            if (this.mEnabled) {
                DropDownListView.super.draw(canvas);
            }
        }

        public void setHotspot(float x, float y) {
            if (this.mEnabled) {
                DropDownListView.super.setHotspot(x, y);
            }
        }

        public void setHotspotBounds(int left, int top, int right, int bottom) {
            if (this.mEnabled) {
                DropDownListView.super.setHotspotBounds(left, top, right, bottom);
            }
        }

        public boolean setVisible(boolean visible, boolean restart) {
            if (this.mEnabled) {
                return DropDownListView.super.setVisible(visible, restart);
            }
            return false;
        }
    }
