...
class BrowserActionsFallbackMenuAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(this.mContext).inflate(C0267R.layout.browser_actions_context_menu_row, (ViewGroup) null);
            viewHolder = new ViewHolderItem();
            viewHolder.mIcon = (ImageView) convertView.findViewById(C0267R.C0270id.browser_actions_menu_item_icon);
            viewHolder.mText = (TextView) convertView.findViewById(C0267R.C0270id.browser_actions_menu_item_text);
