...
public class FontsContractCompat {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:40:0x008e, code lost:
        sBackgroundThread.postAndReply(r2, new androidx.core.provider.FontsContractCompat.C03153());
     */
    ...
    public static android.graphics.Typeface getFontSync(final android.content.Context r9, final androidx.core.provider.FontRequest r10, @androidx.annotation.Nullable final androidx.core.content.res.ResourcesCompat.FontCallback r11, @androidx.annotation.Nullable final android.os.Handler r12, boolean r13, int r14, final int r15) {
        ...
        L_0x0060:
            ...
            monitor-enter(r8)
            androidx.collection.SimpleArrayMap<java.lang.String, java.util.ArrayList<androidx.core.provider.SelfDestructiveThread$ReplyCallback<androidx.core.provider.FontsContractCompat$TypefaceResult>>> r7 = sPendingReplies     // Catch:{ all -> 0x0075 }
            java.lang.Object r4 = r7.get(r3)     // Catch:{ all -> 0x0075 }
            java.util.ArrayList r4 = (java.util.ArrayList) r4     // Catch:{ all -> 0x0075 }
            if (r4 == 0) goto L_0x007e
            if (r5 == 0) goto L_0x0072
            r4.add(r5)     // Catch:{ all -> 0x0075 }
        L_0x0072:
            r0 = 0
        ...
        L_0x007e:
            ...
            java.util.ArrayList r4 = new java.util.ArrayList     // Catch:{ all -> 0x0075 }
            r4.<init>()     // Catch:{ all -> 0x0075 }
            r4.add(r5)     // Catch:{ all -> 0x0075 }
            androidx.collection.SimpleArrayMap<java.lang.String, java.util.ArrayList<androidx.core.provider.SelfDestructiveThread$ReplyCallback<androidx.core.provider.FontsContractCompat$TypefaceResult>>> r7 = sPendingReplies     // Catch:{ all -> 0x0075 }
            r7.put(r3, r4)     // Catch:{ all -> 0x0075 }
        L_0x008d:
            monitor-exit(r8)     // Catch:{ all -> 0x0075 }
    ...
    public static class FontInfo {
        ...
        @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP_PREFIX})
        public FontInfo(@NonNull Uri uri, @IntRange(from = 0) int ttcIndex, @IntRange(from = 1, mo3621to = 1000) int weight, boolean italic, int resultCode) {
    ...
    static FontInfo[] getFontFromProvider(Context context, FontRequest request, String authority, CancellationSignal cancellationSignal) {
        ...
        try {
            if (Build.VERSION.SDK_INT > 16) {
                cursor = context.getContentResolver().query(uri, new String[]{APEZProvider.FILEID, "file_id", "font_ttc_index", "font_variation_settings", "font_weight", "font_italic", "result_code"}, "query = ?", new String[]{request.getQuery()}, (String) null, cancellationSignal);
            } else {
                cursor = context.getContentResolver().query(uri, new String[]{APEZProvider.FILEID, "file_id", "font_ttc_index", "font_variation_settings", "font_weight", "font_italic", "result_code"}, "query = ?", new String[]{request.getQuery()}, (String) null);
            }
