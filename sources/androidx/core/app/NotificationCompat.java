...
public class NotificationCompat {
    ...
    public static class Builder {
        ...
        private Bitmap reduceLargeIconSize(Bitmap icon) {
            ...
            int maxWidth = res.getDimensionPixelSize(C0296R.dimen.compat_notification_large_icon_max_width);
            int maxHeight = res.getDimensionPixelSize(C0296R.dimen.compat_notification_large_icon_max_height);
    ...
    public static abstract class Style {
        ...
        public RemoteViews applyStandardTemplate(boolean showSmallIcon, int resId, boolean fitIn1U) {
            ...
            if (Build.VERSION.SDK_INT >= 16 && Build.VERSION.SDK_INT < 21) {
                if (minPriority) {
                    contentView.setInt(C0296R.C0299id.notification_background, "setBackgroundResource", C0296R.C0298drawable.notification_bg_low);
                    contentView.setInt(C0296R.C0299id.icon, "setBackgroundResource", C0296R.C0298drawable.notification_template_icon_low_bg);
                } else {
                    contentView.setInt(C0296R.C0299id.notification_background, "setBackgroundResource", C0296R.C0298drawable.notification_bg);
                    contentView.setInt(C0296R.C0299id.icon, "setBackgroundResource", C0296R.C0298drawable.notification_template_icon_bg);
                }
            }
            if (this.mBuilder.mLargeIcon != null) {
                if (Build.VERSION.SDK_INT >= 16) {
                    contentView.setViewVisibility(C0296R.C0299id.icon, 0);
                    contentView.setImageViewBitmap(C0296R.C0299id.icon, this.mBuilder.mLargeIcon);
                } else {
                    contentView.setViewVisibility(C0296R.C0299id.icon, 8);
                }
                if (showSmallIcon && this.mBuilder.mNotification.icon != 0) {
                    int backgroundSize = res.getDimensionPixelSize(C0296R.dimen.notification_right_icon_size);
                    int iconSize = backgroundSize - (res.getDimensionPixelSize(C0296R.dimen.notification_small_icon_background_padding) * 2);
                    if (Build.VERSION.SDK_INT >= 21) {
                        contentView.setImageViewBitmap(C0296R.C0299id.right_icon, createIconWithBackground(this.mBuilder.mNotification.icon, backgroundSize, iconSize, this.mBuilder.getColor()));
                    } else {
                        contentView.setImageViewBitmap(C0296R.C0299id.right_icon, createColoredBitmap(this.mBuilder.mNotification.icon, -1));
                    }
                    contentView.setViewVisibility(C0296R.C0299id.right_icon, 0);
                }
            } else if (showSmallIcon && this.mBuilder.mNotification.icon != 0) {
                contentView.setViewVisibility(C0296R.C0299id.icon, 0);
                if (Build.VERSION.SDK_INT >= 21) {
                    contentView.setImageViewBitmap(C0296R.C0299id.icon, createIconWithBackground(this.mBuilder.mNotification.icon, res.getDimensionPixelSize(C0296R.dimen.notification_large_icon_width) - res.getDimensionPixelSize(C0296R.dimen.notification_big_circle_margin), res.getDimensionPixelSize(C0296R.dimen.notification_small_icon_size_as_large), this.mBuilder.getColor()));
                } else {
                    contentView.setImageViewBitmap(C0296R.C0299id.icon, createColoredBitmap(this.mBuilder.mNotification.icon, -1));
                }
            }
            if (this.mBuilder.mContentTitle != null) {
                contentView.setTextViewText(C0296R.C0299id.title, this.mBuilder.mContentTitle);
            }
            if (this.mBuilder.mContentText != null) {
                contentView.setTextViewText(C0296R.C0299id.text, this.mBuilder.mContentText);
                showLine3 = true;
            }
            boolean hasRightSide = Build.VERSION.SDK_INT < 21 && this.mBuilder.mLargeIcon != null;
            if (this.mBuilder.mContentInfo != null) {
                contentView.setTextViewText(C0296R.C0299id.info, this.mBuilder.mContentInfo);
                contentView.setViewVisibility(C0296R.C0299id.info, 0);
                showLine3 = true;
                hasRightSide = true;
            } else if (this.mBuilder.mNumber > 0) {
                if (this.mBuilder.mNumber > res.getInteger(C0296R.integer.status_bar_notification_info_maxnum)) {
                    contentView.setTextViewText(C0296R.C0299id.info, res.getString(C0296R.string.status_bar_notification_info_overflow));
                } else {
                    contentView.setTextViewText(C0296R.C0299id.info, NumberFormat.getIntegerInstance().format((long) this.mBuilder.mNumber));
                }
                contentView.setViewVisibility(C0296R.C0299id.info, 0);
                showLine3 = true;
                hasRightSide = true;
            } else {
                contentView.setViewVisibility(C0296R.C0299id.info, 8);
            }
            if (this.mBuilder.mSubText != null && Build.VERSION.SDK_INT >= 16) {
                contentView.setTextViewText(C0296R.C0299id.text, this.mBuilder.mSubText);
                if (this.mBuilder.mContentText != null) {
                    contentView.setTextViewText(C0296R.C0299id.text2, this.mBuilder.mContentText);
                    contentView.setViewVisibility(C0296R.C0299id.text2, 0);
                    showLine2 = true;
                } else {
                    contentView.setViewVisibility(C0296R.C0299id.text2, 8);
                }
            }
            if (showLine2 && Build.VERSION.SDK_INT >= 16) {
                if (fitIn1U) {
                    contentView.setTextViewTextSize(C0296R.C0299id.text, 0, (float) res.getDimensionPixelSize(C0296R.dimen.notification_subtext_size));
                }
                contentView.setViewPadding(C0296R.C0299id.line1, 0, 0, 0, 0);
            }
            if (this.mBuilder.getWhenIfShowing() != 0) {
                if (!this.mBuilder.mUseChronometer || Build.VERSION.SDK_INT < 16) {
                    contentView.setViewVisibility(C0296R.C0299id.time, 0);
                    contentView.setLong(C0296R.C0299id.time, "setTime", this.mBuilder.getWhenIfShowing());
                } else {
                    contentView.setViewVisibility(C0296R.C0299id.chronometer, 0);
                    contentView.setLong(C0296R.C0299id.chronometer, "setBase", this.mBuilder.getWhenIfShowing() + (SystemClock.elapsedRealtime() - System.currentTimeMillis()));
                    contentView.setBoolean(C0296R.C0299id.chronometer, "setStarted", true);
                }
                hasRightSide = true;
            }
            contentView.setViewVisibility(C0296R.C0299id.right_side, hasRightSide ? 0 : 8);
            contentView.setViewVisibility(C0296R.C0299id.line3, showLine3 ? 0 : 8);
            return contentView;
        }
        ...
        private Bitmap createIconWithBackground(int iconId, int size, int iconSize, int color) {
            int i = C0296R.C0298drawable.notification_icon_background;
            if (color == 0) {
                color = 0;
            }
        ...
        public void buildIntoRemoteViews(RemoteViews outerView, RemoteViews innerView) {
            ...
            outerView.removeAllViews(C0296R.C0299id.notification_main_column);
            outerView.addView(C0296R.C0299id.notification_main_column, innerView.clone());
            outerView.setViewVisibility(C0296R.C0299id.notification_main_column, 0);
            if (Build.VERSION.SDK_INT >= 21) {
                outerView.setViewPadding(C0296R.C0299id.notification_main_column_container, 0, calculateTopPadding(), 0, 0);
            }
        }

        private void hideNormalContent(RemoteViews outerView) {
            outerView.setViewVisibility(C0296R.C0299id.title, 8);
            outerView.setViewVisibility(C0296R.C0299id.text2, 8);
            outerView.setViewVisibility(C0296R.C0299id.text, 8);
        }

        private int calculateTopPadding() {
            Resources resources = this.mBuilder.mContext.getResources();
            int padding = resources.getDimensionPixelSize(C0296R.dimen.notification_top_pad);
            int largePadding = resources.getDimensionPixelSize(C0296R.dimen.notification_top_pad_large_text);
            ...
            if (Build.VERSION.SDK_INT >= 16) {
                ...
                for (int i = this.mMessages.size() - 1; i >= 0; i--) {
                    ...
                    if (i != this.mMessages.size() - 1) {
                        completeMessage.insert(0, ShellAdbUtil.COMMAND_LINE_END);
                    }
    ...
    public static class DecoratedCustomViewStyle extends Style {
        ...
        private RemoteViews createRemoteViews(RemoteViews innerView, boolean showActions) {
            ...
            RemoteViews remoteViews = applyStandardTemplate(true, C0296R.layout.notification_template_custom_big, false);
            remoteViews.removeAllViews(C0296R.C0299id.actions);
            boolean actionsVisible = false;
            if (showActions && this.mBuilder.mActions != null && (numActions = Math.min(this.mBuilder.mActions.size(), 3)) > 0) {
                actionsVisible = true;
                for (int i = 0; i < numActions; i++) {
                    remoteViews.addView(C0296R.C0299id.actions, generateActionButton(this.mBuilder.mActions.get(i)));
                }
            }
            if (!actionsVisible) {
                actionVisibility = 8;
            }
            remoteViews.setViewVisibility(C0296R.C0299id.actions, actionVisibility);
            remoteViews.setViewVisibility(C0296R.C0299id.action_divider, actionVisibility);
        ...
        private RemoteViews generateActionButton(Action action) {
            ...
            RemoteViews button = new RemoteViews(this.mBuilder.mContext.getPackageName(), tombstone ? C0296R.layout.notification_action_tombstone : C0296R.layout.notification_action);
            button.setImageViewBitmap(C0296R.C0299id.action_image, createColoredBitmap(action.getIcon(), this.mBuilder.mContext.getResources().getColor(C0296R.color.notification_action_color_filter)));
            button.setTextViewText(C0296R.C0299id.action_text, action.title);
            if (!tombstone) {
                button.setOnClickPendingIntent(C0296R.C0299id.action_container, action.actionIntent);
            }
            if (Build.VERSION.SDK_INT >= 15) {
                button.setContentDescription(C0296R.C0299id.action_container, action.title);
            }
            return button;
        }
    }
