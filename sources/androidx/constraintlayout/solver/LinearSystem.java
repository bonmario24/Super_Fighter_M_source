...
public class LinearSystem {
    ...
    public SolverVariable createObjectVariable(Object anchor) {
        ...
        this.mVariablesID++;
        this.mNumColumns++;
        variable.f20id = this.mVariablesID;
    ...
    private final int optimize(androidx.constraintlayout.solver.LinearSystem.Row r21, boolean r22) {
        /*
            r20 = this;
            androidx.constraintlayout.solver.Metrics r15 = sMetrics
        ...
        L_0x0026:
            ...
            r0 = r20
            androidx.constraintlayout.solver.ArrayRow[] r15 = r0.mRows
            r8 = r15[r9]
            androidx.constraintlayout.solver.SolverVariable r15 = r8.variable
            r16 = -1
            r0 = r16
            r15.definitionId = r0
            androidx.constraintlayout.solver.Metrics r15 = sMetrics
        ...
        L_0x0076:
            ...
            r0 = r20
            boolean[] r15 = r0.mAlreadyTestedCandidates
            androidx.constraintlayout.solver.SolverVariable r16 = r21.getKey()
            r0 = r16
            int r0 = r0.f20id
            r16 = r0
            r17 = 1
        ...
        L_0x008e:
            ...
            r0 = r21
            r1 = r20
            androidx.constraintlayout.solver.SolverVariable r7 = r0.getPivotCandidate(r1, r15)
        ...
        L_0x00be:
            ...
            androidx.constraintlayout.solver.ArrayRow[] r15 = r0.mRows
            r3 = r15[r5]
            androidx.constraintlayout.solver.SolverVariable r14 = r3.variable
            androidx.constraintlayout.solver.SolverVariable$Type r15 = r14.mType
            androidx.constraintlayout.solver.SolverVariable$Type r16 = androidx.constraintlayout.solver.SolverVariable.Type.UNRESTRICTED
            r0 = r16
        ...
        L_0x00d7:
            ...
            if (r15 == 0) goto L_0x00d4
            androidx.constraintlayout.solver.ArrayLinkedVariables r15 = r3.variables
            float r2 = r15.get(r7)
            r15 = 0
    ...
    private void displayRows() {
        ...
        String s = "";
        for (int i = 0; i < this.mNumRows; i++) {
            s = (s + this.mRows[i]) + ShellAdbUtil.COMMAND_LINE_END;
        }
        System.out.println(s + this.mGoal + ShellAdbUtil.COMMAND_LINE_END);
    }
    ...
    public void displayReadableRows() {
        ...
        if (this.mGoal != null) {
            s = s + this.mGoal + ShellAdbUtil.COMMAND_LINE_END;
        }
    ...
    public void displayVariablesReadableRows() {
        ...
        for (int i = 0; i < this.mNumRows; i++) {
            if (this.mRows[i].variable.mType == SolverVariable.Type.UNRESTRICTED) {
                s = (s + this.mRows[i].toReadableString()) + ShellAdbUtil.COMMAND_LINE_END;
            }
        }
        System.out.println(s + this.mGoal + ShellAdbUtil.COMMAND_LINE_END);
    }
