...
public class ConstraintWidget {
    ...
    public String toString() {
        return (this.mType != null ? "type: " + this.mType + " " : "") + (this.mDebugName != null ? "id: " + this.mDebugName + " " : "") + "(" + this.f22mX + ", " + this.f23mY + ") - (" + this.mWidth + " x " + this.mHeight + ") wrap: (" + this.mWrapWidth + " x " + this.mWrapHeight + ")";
    }
    ...
    public void setDrawOrigin(int x, int y) {
        ...
        this.f22mX = this.mDrawX;
        this.f23mY = this.mDrawY;
    }
